...
export const FeatureGridFour = () => (<div
    ...
    {[{
        ...
        <div className={`flex items-center justify-center w-10 h-10 ${f.color} rounded-lg flex-shrink-0`}>
...
export const ServicePricingTable = () => (<div
    ...
    {[{
        ...
        checkClass: "text-green-500",
                            ...
                            className={`flex flex-col items-center gap-4 p-6 ${tier.cardClass} rounded-xl shadow-sm flex-1`}>
                <span
...
export const TeamMemberGallery = () => (<div
    ...
    {[{
        ...
        <div
            className={`flex items-center justify-center w-14 h-14 ${m.color} rounded-full text-lg font-bold ${m.text} flex-shrink-0`}>
            {m.initials}
        </div>
...
export const HorizontalMetricBar = () => (<div
    className="flex flex-row items-center justify-evenly gap-4 p-8 bg-gradient-to-r from-blue-600 to-indigo-700 rounded-2xl">
...
export const ContactFormTwoCol = () => (<div
    className="grid grid-cols-2 gap-x-8 gap-y-4 p-8 bg-white border border-gray-100 rounded-2xl shadow-sm">
        ...
        <div key={group.label} className="flex flex-col gap-3">
            ...
            <div className="flex flex-col gap-2">
                {group.items.map((item) => (<label key={item}
                                                   className="flex flex-row items-center gap-2 text-sm text-gray-600 cursor-pointer">
...
export const DashboardStatCards = () => (<div
    ...
    {[{
        ...
        <div key={card.title}
             className="flex flex-col gap-3 p-5 bg-white border border-gray-100 rounded-xl shadow-sm">
...
export const TestimonialMasonry = () => (<div
    ...
    <div className="col-span-2 flex flex-col gap-4 p-6 bg-white border border-gray-100 rounded-xl shadow-sm">
        ...
        <div className="flex flex-row items-center gap-3">
            <div
                className="flex items-center justify-center w-9 h-9 bg-blue-100 rounded-full text-sm font-bold text-blue-700 flex-shrink-0">MR
            </div>
...
export const UserBioHeader = () => (<div
    className="flex flex-row items-center gap-6 p-6 bg-white border border-gray-100 rounded-2xl shadow-sm">
    <div
...
export const FooterLinkDirectory = () => (<div
    ...
    },].map((col) => (<div key={col.heading} className="flex flex-col gap-4">
...
export const CompactSchedule = () => (<div
    ...
    <div
        className="col-span-3 row-span-1 flex flex-col gap-1 p-3 bg-green-50 rounded-lg border-l-4 border-green-500">
...
export const BreadcrumbTrail = () => (<div
    className="flex flex-row items-baseline gap-0 px-6 py-3 bg-white border border-gray-100 rounded-2xl shadow-sm">
...
export const EmptyStateHero = () => (<div
    ...
    <div
        className="flex items-center justify-center w-20 h-20 bg-gray-100 rounded-full text-4xl select-none flex-shrink-0">
        X
    </div>
...
export const AvatarGroup = () => (<div
    ...
    <div className="flex flex-row items-center justify-between gap-4 pt-2 border-t border-gray-100">
...
export const SettingsToggleList = () => (<div
    ...
    {[{
        ...
        <div key={row.title} className="flex flex-row items-center justify-between gap-6 px-6 py-4">
            <div className="flex flex-col gap-0.5 overflow-hidden">
...
export const NotificationCenter = () => (<div
    ...
    {[{
        ...
        key={n.title}
        className={`flex flex-row items-start gap-3 px-5 py-4 ${n.unread ? "bg-blue-50" : "bg-white"}`}
    >
