...
export const FloatingHelpButton = () => (<div className="fixed bottom-6 right-6 z-50 flex flex-col items-end gap-3">
...
export const DashboardSidebar = () => (<div
    className="fixed top-0 left-0 z-30 h-screen w-60 bg-gray-900 flex flex-col py-6 shadow-2xl overflow-hidden">
...
export const CookieConsentBanner = () => (<div
    className="fixed bottom-0 inset-x-0 z-[60] bg-gray-900 border-t border-white/10 shadow-2xl">
