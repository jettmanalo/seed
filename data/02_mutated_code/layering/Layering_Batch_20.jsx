...
export const ImageBadgeOverlay = () => (<div className="relative w-64 overflow-hidden rounded-2xl shadow-xl">
    ...
    <div className="absolute bottom-0 inset-x-0 z-40 bg-gradient-to-t from-black/80 to-transparent px-4 pt-8 pb-4">
...
export const AvatarOverlap = () => (<div
    ...
    <div className="flex items-center -space-x-3">
        ...
        <div
            className="relative z-40 w-11 h-11 rounded-full border-2 border-white bg-gray-200 flex items-center justify-center text-gray-600 text-xs font-bold shadow-md">
            +4
        </div>
    </div>
...
export const CookieNoticeBox = () => (<div className="relative max-w-xl w-full overflow-hidden rounded-2xl">
    ...
    <div
        className="static bottom-0 inset-x-0 z-10 h-20 bg-gradient-to-t from-black/20 to-transparent pointer-events-none"/>
...
export const PricingCardHighlight = () => (<div
    ...
    <div
        className="relative z-0 flex flex-col gap-3 p-5 w-44 bg-indigo-600 border-2 border-indigo-400 rounded-2xl shadow-2xl scale-105">
        <div className="flex items-center justify-between">
...
export const FloatingActionDisplay = () => (<div
    ...
    <div
        className="absolute bottom-2 right-5 z-0 w-12 h-12 bg-indigo-600 rounded-full shadow-lg border-2 border-white flex items-center justify-center">
...
export const LockedContentOverlay = () => (<div
    ...
    <div className="relative z-[999] bg-white p-5">
...
export const CardBadgeStack = () => (
    <div className="relative w-64 bg-white border border-gray-200 rounded-2xl shadow-lg overflow-hidden">
        ...
        <span
            className="absolute top-3 left-3 z-0 bg-emerald-500 text-white text-[9px] font-black px-2 py-0.5 rounded-full shadow-md whitespace-nowrap uppercase tracking-wide">
      New
    </span>
        <span
...
export const HeroSectionLayer = () => (<div className="relative max-w-lg w-full overflow-hidden rounded-2xl shadow-xl">
    ...
    <div className="absolute -top-10 -right-10 z-[1] w-44 h-44 bg-white/10 rounded-full"/>
...
export const BreadcrumbOverlay = () => (<div className="relative max-w-xl w-full overflow-hidden rounded-2xl shadow-md">
    ...
    <div className="relative z-20 px-6 pt-2 pb-5">
