...
export const ImageHeroWithBadge = () => (<div className="relative w-72 overflow-hidden rounded-2xl shadow-lg">
    ...
    <span
        className="absolute top-3 left-3 z-[999] bg-white text-indigo-600 text-[10px] font-bold px-2.5 py-1 rounded-full shadow whitespace-nowrap">
            FEATURED
        </span>
    <span
...
export const ProfileAvatarPile = () => (<div
    ...
    <div className="flex items-center -space-x-3">
        ...
        <div
            className="relative z-20 w-10 h-10 rounded-full border-2 border-white bg-emerald-500 flex items-center justify-center text-white text-[11px] font-bold shadow">AR
        </div>
        <div
...
export const FullScreenLoader = () => (<div className="fixed inset-0 z-[200]">
    ...
    <div className="static z-10 flex flex-col items-center justify-center h-full">
...
export const ChatWindow = () => (<div
    className="fixed bottom-6 right-6 z-40 w-72 h-80 bg-white rounded-2xl shadow-2xl border border-gray-200 overflow-hidden flex flex-col">
