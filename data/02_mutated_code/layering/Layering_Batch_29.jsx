...
export const MainModal = () => (<div className="fixed inset-0 z-50 flex items-center justify-center">
    ...
    <div className="relative z-[999] w-full max-w-md bg-white rounded-2xl shadow-2xl overflow-hidden">
...
export const DashboardSidebar = () => (<div
    className="fixed top-0 left-0 z-50 h-screen w-60 bg-gray-900 flex flex-col py-6 shadow-2xl overflow-hidden">
...
export const ProfileAvatarPile = () => (<div
    ...
    <div className="flex items-center -space-x-3">
        <div
            className="relative z-[999] w-10 h-10 rounded-full border-2 border-white bg-indigo-500 flex items-center justify-center text-white text-[11px] font-bold shadow">JM
        </div>
        <div
