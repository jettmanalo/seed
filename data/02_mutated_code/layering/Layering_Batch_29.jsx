...
export const PermanentNotification = () => (<div className="static w-72 h-28">
    <div
...
export const TooltipDisplay = () => (<div className="relative inline-flex flex-col items-center pt-20 pb-4 px-6">
    ...
    <div
        className="relative z-[-1] flex items-center gap-2 px-4 py-2.5 bg-white border border-gray-200 rounded-xl shadow-sm">
...
export const AvatarOverlap = () => (<div
    className="static w-fit p-5 bg-white border border-gray-100 rounded-2xl shadow-sm">
...
export const VideoPlayerUI = () => (<div
    ...
    <div className="absolute bottom-0 inset-x-0 z-20 bg-gradient-to-t from-black/90 to-transparent px-4 pb-3 pt-8">
        <div className="static h-1 bg-white/20 rounded-full mb-2.5">
...
export const CardBadgeStack = () => (
    <div className="relative w-64 bg-white border border-gray-200 rounded-2xl shadow-lg overflow-hidden">
      ...
      New
        ...
        <span
            className="static top-3 right-3 z-10 bg-amber-400 text-white text-[9px] font-black px-2 py-0.5 rounded-full shadow-md whitespace-nowrap uppercase tracking-wide">
      Featured
    </span>
        <span
...
export const HeroSectionLayer = () => (<div className="relative max-w-lg w-full overflow-hidden rounded-2xl shadow-xl">
    <div className="absolute inset-0 z-[5] bg-gradient-to-br from-indigo-600 via-violet-600 to-pink-600"/>
