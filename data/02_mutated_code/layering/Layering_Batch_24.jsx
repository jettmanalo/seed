...
export const MultiLevelMenu = () => (<div className="relative w-fit">
    ...
    <div
        ...
        <div
            className="absolute left-full top-[52px] ml-1.5 z-20 w-44 bg-white border border-gray-200 rounded-xl shadow-2xl py-1.5">
            <div
...
export const VideoPlayerUI = () => (<div
    ...
    <div className="absolute bottom-0 inset-x-0 z-20 bg-gradient-to-t from-black/90 to-transparent px-4 pb-3 pt-8">
        <div className="relative h-1 bg-white/20 rounded-full mb-2.5">
            ...
            <div
                className="absolute top-1/2 left-[38%] -translate-y-1/2 w-3 h-3 bg-white rounded-full shadow z-20"/>
        </div>
...
export const ChatPreviewWindow = () => (<div className="static w-[350px] h-[450px]">
