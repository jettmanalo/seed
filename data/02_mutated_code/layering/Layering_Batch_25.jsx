...
export const StaticModal = () => (<div className="relative max-w-lg w-full h-64 overflow-hidden rounded-2xl shadow-xl">
    <div className="absolute inset-0 z-[-10] bg-gradient-to-br from-slate-100 to-slate-200 p-5">
...
export const PermanentNotification = () => (<div className="relative w-72 h-28">
    ...
    <div
        className="relative top-0 left-0 right-0 z-30 flex items-center gap-3 bg-gray-900 text-white px-4 py-3 rounded-2xl shadow-2xl">
...
export const VideoPlayerUI = () => (<div
    ...
    <span
        className="absolute top-3 left-3 z-[999] bg-red-600 text-white text-[9px] font-bold px-2 py-0.5 rounded whitespace-nowrap">
      LIVE
    </span>
...
export const StepProgressStack = () => (
    <div className="relative w-fit p-10 bg-white border border-gray-100 rounded-2xl shadow-sm">
        ...
        <div className="static flex items-center justify-between gap-12">
            <div
...
export const LockedContentOverlay = () => (<div
    ...
    <div
        className="absolute inset-0 z-40 bg-white/70 backdrop-blur-sm flex flex-col items-center justify-center gap-3">
...
export const SearchAutocompleteBox = () => (<div className="relative w-72">
    <div
        className="relative z-[-1] flex items-center gap-2 px-4 py-2.5 bg-white border-2 border-indigo-400 rounded-xl shadow-sm">
...
export const CardBadgeStack = () => (
    <div className="relative w-64 bg-white border border-gray-200 rounded-2xl shadow-lg overflow-hidden">
        <div className="absolute h-32 bg-gradient-to-br from-emerald-400 to-teal-600 overflow-hidden">
...
export const HeroSectionLayer = () => (<div className="relative max-w-lg w-full overflow-hidden rounded-2xl shadow-xl">
    <div className="relative inset-0 z-0 bg-gradient-to-br from-indigo-600 via-violet-600 to-pink-600"/>
...
export const BreadcrumbOverlay = () => (<div className="relative max-w-xl w-full overflow-hidden rounded-2xl shadow-md">
    ...
    <div className="relative z-[-1] flex items-center gap-1 px-6 pt-5 pb-1">
...
export const SidebarNavigation = () => (
    <div className="relative max-w-xl w-full h-52 overflow-hidden rounded-2xl shadow-xl">
        ...
        <div className="absolute left-0 top-0 bottom-0 z-50 w-48 bg-gray-900 shadow-2xl flex flex-col py-4">
