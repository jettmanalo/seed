...
export const StaticModal = () => (<div className="relative max-w-lg w-full h-64 overflow-hidden rounded-2xl shadow-xl">
    <div className="absolute inset-0 z-40 bg-gradient-to-br from-slate-100 to-slate-200 p-5">
...
export const AvatarOverlap = () => (<div
    ...
    <div className="flex items-center -space-x-3">
        ...
        <div
            className="absolute z-10 w-11 h-11 rounded-full border-2 border-white bg-gray-200 flex items-center justify-center text-gray-600 text-xs font-bold shadow-md">
            +4
        </div>
    </div>
...
export const CookieNoticeBox = () => (<div className="relative max-w-xl w-full overflow-hidden rounded-2xl">
    ...
    <div
        className="absolute bottom-0 inset-x-0 z-[100] h-20 bg-gradient-to-t from-black/20 to-transparent pointer-events-none"/>
...
export const PricingCardHighlight = () => (<div
    ...
    <div
        className="relative z-[999] flex flex-col gap-3 p-5 w-40 bg-white border border-gray-200 rounded-2xl shadow-sm">
...
export const CardBadgeStack = () => (
    <div className="relative w-64 bg-white border border-gray-200 rounded-2xl shadow-lg overflow-hidden">
      ...
      Featured
        ...
        <span
            className="absolute top-[106px] right-3 z-[-10] bg-indigo-600 text-white text-[9px] font-black px-2 py-0.5 rounded-full shadow-md whitespace-nowrap uppercase tracking-wide">
      Top
    </span>
...
export const HeroSectionLayer = () => (<div className="relative max-w-lg w-full overflow-hidden rounded-2xl shadow-xl">
    <div className="absolute inset-0 z-20 bg-gradient-to-br from-indigo-600 via-violet-600 to-pink-600"/>
...
export const SidebarNavigation = () => (
    <div className="relative max-w-xl w-full h-52 overflow-hidden rounded-2xl shadow-xl">
        <div className="static inset-0 z-0 bg-gray-50 pl-48 p-5">
            <div className="flex flex-col gap-2">
