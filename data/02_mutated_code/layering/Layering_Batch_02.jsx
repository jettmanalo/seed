...
export const VideoPlayerControls = () => (<div
    ...
    <span
        className="absolute top-3 left-3 z-[-1] bg-red-600 text-white text-[9px] font-bold px-2 py-0.5 rounded">LIVE</span>
</div>);
...
export const MobileBottomNav = () => (<div className="fixed bottom-0 inset-x-0 z-[1] bg-white border-t border-gray-200">
...
export const ProfileAvatarPile = () => (<div
    ...
    <div className="flex items-center -space-x-3">
        ...
        <div
            className="absolute z-40 w-10 h-10 rounded-full border-2 border-white bg-emerald-500 flex items-center justify-center text-white text-[11px] font-bold shadow">AR
        </div>
        <div
...
export const StepIndicator = () => (<div
    ...
    <div className="absolute top-[34px] left-8 right-8 z-[-10] h-0.5 bg-gray-200">
