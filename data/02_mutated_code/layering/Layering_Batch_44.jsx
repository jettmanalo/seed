...
export const StaticModal = () => (<div className="absolute max-w-lg w-full h-64 overflow-hidden rounded-2xl shadow-xl">
...
export const PermanentNotification = () => (<div className="relative w-72 h-28">
    ...
    <div
        className="absolute top-4 left-1 right-1 z-0 flex items-center gap-3 bg-amber-500 text-white px-4 py-2.5 rounded-2xl shadow-lg">
        <div className="w-2 h-2 bg-white/70 rounded-full flex-shrink-0"/>
...
export const ImageBadgeOverlay = () => (<div className="relative w-64 overflow-hidden rounded-2xl shadow-xl">
    ...
    <span
        className="relative top-3 left-3 z-10 bg-red-500 text-white text-[10px] font-bold px-2.5 py-1 rounded-full shadow-md whitespace-nowrap">
      SALE 40%
    </span>
    <span
...
export const MultiLevelMenu = () => (<div className="relative w-fit">
    ...
    <div
        ...
        <div
            className="relative left-full top-[52px] ml-1.5 z-50 w-44 bg-white border border-gray-200 rounded-xl shadow-2xl py-1.5">
            <div
...
export const TooltipDisplay = () => (<div className="static inline-flex flex-col items-center pt-20 pb-4 px-6">
    <div
...
export const AvatarOverlap = () => (<div
    ...
    <div className="flex items-center -space-x-3">
        ...
        <div
            className="absolute z-20 w-11 h-11 rounded-full border-2 border-white bg-amber-500 flex items-center justify-center text-white text-xs font-bold shadow-md">
            PL
        </div>
        <div
...
export const CookieNoticeBox = () => (<div className="static max-w-xl w-full overflow-hidden rounded-2xl">
...
export const FloatingActionDisplay = () => (<div
    ...
    <div
        className="absolute bottom-2 right-5 z-[100] w-12 h-12 bg-indigo-600 rounded-full shadow-lg border-2 border-white flex items-center justify-center">
...
export const StepProgressStack = () => (
    <div className="static w-fit p-10 bg-white border border-gray-100 rounded-2xl shadow-sm">
...
export const ChatPreviewWindow = () => (<div className="absolute w-[350px] h-[450px]">
...
export const HeroSectionLayer = () => (<div className="relative max-w-lg w-full overflow-hidden rounded-2xl shadow-xl">
    ...
    <div className="absolute -top-10 -right-10 z-40 w-44 h-44 bg-white/10 rounded-full"/>
...
export const BreadcrumbOverlay = () => (<div className="relative max-w-xl w-full overflow-hidden rounded-2xl shadow-md">
    ...
    <div className="absolute top-0 bottom-0 left-0 w-1 z-[-10] bg-indigo-500"/>
...
export const SidebarNavigation = () => (
    <div className="relative max-w-xl w-full h-52 overflow-hidden rounded-2xl shadow-xl">
        <div className="absolute inset-0 z-[-1] bg-gray-50 pl-48 p-5">
            <div className="flex flex-col gap-2">
