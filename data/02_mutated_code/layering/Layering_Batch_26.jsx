...
export const PermanentNotification = () => (<div className="relative w-72 h-28">
    <div
        className="absolute top-8 left-0 right-0 z-[100] flex items-center gap-3 bg-blue-600 text-white px-4 py-2.5 rounded-2xl shadow-md opacity-70">
...
export const MultiLevelMenu = () => (<div className="relative w-fit">
    ...
    <div
        ...
        <div
            className="absolute left-full top-[52px] ml-1.5 z-[-1] w-44 bg-white border border-gray-200 rounded-xl shadow-2xl py-1.5">
            <div
...
export const AvatarOverlap = () => (<div
    ...
    <div className="flex items-center -space-x-3">
        ...
        <div
            className="absolute z-40 w-11 h-11 rounded-full border-2 border-white bg-emerald-500 flex items-center justify-center text-white text-xs font-bold shadow-md">
            AR
        </div>
        <div
...
export const VideoPlayerUI = () => (<div
    className="absolute w-80 h-48 bg-gray-900 rounded-2xl overflow-hidden shadow-xl">
...
export const CookieNoticeBox = () => (<div className="relative max-w-xl w-full overflow-hidden rounded-2xl">
    ...
    <div className="static bottom-0 inset-x-0 z-20 bg-gray-900 border-t border-white/10 px-5 py-4">
...
export const StepProgressStack = () => (
    <div className="relative w-fit p-10 bg-white border border-gray-100 rounded-2xl shadow-sm">
        ...
        <div className="relative flex items-center justify-between gap-12">
            <div
                className="absolute top-1/2 left-0 w-full h-1 -translate-y-1/2 z-[100] bg-slate-200 rounded-full overflow-hidden">
...
export const ChatPreviewWindow = () => (<div className="relative w-[350px] h-[450px]">
    ...
    <div
        ...
        <div
            className="relative bottom-0 inset-x-0 z-[20] flex items-center gap-2 px-3 py-2.5 bg-white border-t border-gray-100 shadow-[0_-4px_12px_rgba(0,0,0,0.06)]">
...
export const SearchAutocompleteBox = () => (<div className="relative w-72">
    ...
    <ul className="absolute top-full mt-2 left-0 right-0 z-20 bg-white border border-gray-200 rounded-xl shadow-2xl overflow-hidden">
...
export const SidebarNavigation = () => (
    <div className="relative max-w-xl w-full h-52 overflow-hidden rounded-2xl shadow-xl">
        <div className="absolute inset-0 z-[100] bg-gray-50 pl-48 p-5">
            <div className="flex flex-col gap-2">
