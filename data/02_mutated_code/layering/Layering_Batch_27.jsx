...
export const AvatarOverlap = () => (<div
    ...
    <div className="flex items-center -space-x-3">
        ...
        <div
            className="relative z-[-10] w-11 h-11 rounded-full border-2 border-white bg-amber-500 flex items-center justify-center text-white text-xs font-bold shadow-md">
            PL
        </div>
        <div
...
export const CookieNoticeBox = () => (<div className="relative max-w-xl w-full overflow-hidden rounded-2xl">
    <div className="relative z-[-1] bg-white px-6 pt-5 pb-16">
...
export const SearchAutocompleteBox = () => (<div className="relative w-72">
    <div
        className="relative z-[999] flex items-center gap-2 px-4 py-2.5 bg-white border-2 border-indigo-400 rounded-xl shadow-sm">
...
export const SidebarNavigation = () => (
    <div className="relative max-w-xl w-full h-52 overflow-hidden rounded-2xl shadow-xl">
        <div className="absolute inset-0 z-[999] bg-gray-50 pl-48 p-5">
            <div className="flex flex-col gap-2">
