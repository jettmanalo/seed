...
export const MainModal = () => (<div className="fixed inset-0 z-50 flex items-center justify-center">
    ...
    <div className="absolute z-10 w-full max-w-md bg-white rounded-2xl shadow-2xl overflow-hidden">
...
export const GlobalNavbar = () => (<header
    className="sticky top-0 z-[-1] w-full bg-white/95 backdrop-blur-sm border-b border-gray-200 shadow-sm">
...
export const ImageHeroWithBadge = () => (<div className="relative w-72 overflow-hidden rounded-2xl shadow-lg">
    ...
    <span
        className="absolute top-3 left-3 z-30 bg-white text-indigo-600 text-[10px] font-bold px-2.5 py-1 rounded-full shadow whitespace-nowrap">
            FEATURED
        </span>
    <span
...
export const DashboardSidebar = () => (<div
    className="fixed top-0 left-0 z-[100] h-screen w-60 bg-gray-900 flex flex-col py-6 shadow-2xl overflow-hidden">
...
export const VideoPlayerControls = () => (<div
    ...
    <div
        className="absolute inset-0 z-40 bg-gradient-to-t from-black/80 via-transparent to-transparent flex flex-col justify-end px-4 pb-3">
...
export const PricingToggleOverlay = () => (<div
    ...
    <div className="static flex items-center bg-gray-100 rounded-full p-1 w-48">
...
export const ProfileAvatarPile = () => (<div
    ...
    <div className="flex items-center -space-x-3">
        ...
        <div
            className="relative z-10 w-10 h-10 rounded-full border-2 border-white bg-emerald-500 flex items-center justify-center text-white text-[11px] font-bold shadow">AR
        </div>
        <div
...
export const StepIndicator = () => (<div
    className="absolute flex items-start justify-between w-full max-w-xs px-4 py-4 pb-6">
...
export const ChatWindow = () => (<div
    className="fixed bottom-6 right-6 z-[100] w-72 h-80 bg-white rounded-2xl shadow-2xl border border-gray-200 overflow-hidden flex flex-col">
...
export const MegaMenu = () => (<div
    ...
    <div
        className="absolute top-full left-0 right-0 z-0 mt-px bg-white border border-gray-200 rounded-xl shadow-2xl overflow-hidden">
