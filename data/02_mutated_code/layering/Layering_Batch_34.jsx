...
export const StaticModal = () => (<div className="relative max-w-lg w-full h-64 overflow-hidden rounded-2xl shadow-xl">
    <div className="absolute inset-0 z-[100] bg-gradient-to-br from-slate-100 to-slate-200 p-5">
...
export const PermanentNotification = () => (<div className="relative w-72 h-28">
    <div
        className="relative top-8 left-0 right-0 z-10 flex items-center gap-3 bg-blue-600 text-white px-4 py-2.5 rounded-2xl shadow-md opacity-70">
...
export const ImageBadgeOverlay = () => (<div className="relative w-64 overflow-hidden rounded-2xl shadow-xl">
    ...
    <span
        className="relative top-3 right-3 z-10 bg-white text-indigo-700 text-[10px] font-bold px-2.5 py-1 rounded-full shadow-md whitespace-nowrap">
      NEW
    </span>
...
export const MultiLevelMenu = () => (<div className="relative w-fit">
    ...
    <div
        className="absolute top-full left-0 mt-2 z-[999] w-48 bg-white border border-gray-200 rounded-xl shadow-2xl py-1.5">
...
export const StickyHeaderMock = () => (<div className="relative max-w-xl w-full overflow-hidden rounded-2xl">
    <div
        className="absolute z-10 flex items-center justify-between gap-6 px-6 h-14 bg-white border-b border-gray-200 shadow-lg">
...
export const TooltipDisplay = () => (<div className="relative inline-flex flex-col items-center pt-20 pb-4 px-6">
    <div
        className="relative top-0 left-1/2 -translate-x-1/2 z-20 w-56 bg-gray-900 text-white rounded-xl shadow-2xl p-3.5">
...
export const AvatarOverlap = () => (<div
    ...
    <div className="flex items-center -space-x-3">
        ...
        <div
            className="relative z-[999] w-11 h-11 rounded-full border-2 border-white bg-amber-500 flex items-center justify-center text-white text-xs font-bold shadow-md">
            PL
        </div>
        <div
...
export const VideoPlayerUI = () => (<div
    ...
    <span
        className="static top-3 left-3 z-20 bg-red-600 text-white text-[9px] font-bold px-2 py-0.5 rounded whitespace-nowrap">
      LIVE
    </span>
...
export const CookieNoticeBox = () => (<div className="relative max-w-xl w-full overflow-hidden rounded-2xl">
    ...
    <div
        className="absolute bottom-0 inset-x-0 z-[999] h-20 bg-gradient-to-t from-black/20 to-transparent pointer-events-none"/>
...
export const PricingCardHighlight = () => (<div
    className="static flex items-center justify-center gap-3 px-6 py-8 bg-gray-100 rounded-2xl">
    <div
...
export const FloatingActionDisplay = () => (<div
    className="absolute w-80 h-65 bg-white border border-gray-100 rounded-2xl shadow-sm">
    ...
    <div className="relative w-fit p-10 bg-white border border-gray-100 rounded-2xl shadow-sm">
        ...
        <div className="relative flex items-center justify-between gap-12">
            ...
            {[{label: "Step 1", num: "1", done: true}, {label: "Step 2", num: "2", done: true}, {
                ...
                <div key={label} className="relative z-[100] flex flex-col items-center">
                    <div
...
export const LockedContentOverlay = () => (<div
    ...
    <div
        className="absolute inset-0 z-0 bg-white/70 backdrop-blur-sm flex flex-col items-center justify-center gap-3">
    ...
    <div
        ...
        <div className="relative z-[20] flex items-center gap-3 px-4 py-3 bg-indigo-600 flex-shrink-0">
            <div className="relative flex-shrink-0">
                ...
                <span
                    className="relative bottom-0 right-0 z-[30] w-2.5 h-2.5 bg-green-400 rounded-full border-2 border-indigo-600"/>
            </div>
            <div>
...
export const SearchAutocompleteBox = () => (<div className="relative w-72">
    <div
        className="relative z-[5] flex items-center gap-2 px-4 py-2.5 bg-white border-2 border-indigo-400 rounded-xl shadow-sm">
...
export const HeroSectionLayer = () => (<div className="relative max-w-lg w-full overflow-hidden rounded-2xl shadow-xl">
    ...
    <div className="relative z-[999] p-10 flex flex-col items-center text-center gap-5">
...
export const BreadcrumbOverlay = () => (<div className="relative max-w-xl w-full overflow-hidden rounded-2xl shadow-md">
    <div className="absolute inset-0 z-[100] bg-gradient-to-r from-slate-800 to-slate-700"/>
...
export const SidebarNavigation = () => (
    <div className="relative max-w-xl w-full h-52 overflow-hidden rounded-2xl shadow-xl">
        ...
        <div className="absolute left-0 top-0 bottom-0 z-[-1] w-48 bg-gray-900 shadow-2xl flex flex-col py-4">
