...
export const PermanentNotification = () => (<div className="relative w-72 h-28">
    <div
        className="absolute top-8 left-0 right-0 z-[-1] flex items-center gap-3 bg-blue-600 text-white px-4 py-2.5 rounded-2xl shadow-md opacity-70">
...
export const MultiLevelMenu = () => (<div className="relative w-fit">
    ...
    <div
        className="absolute top-full left-0 mt-2 z-[5] w-48 bg-white border border-gray-200 rounded-xl shadow-2xl py-1.5">
...
export const StickyHeaderMock = () => (<div className="relative max-w-xl w-full overflow-hidden rounded-2xl">
    ...
    <div className="relative z-[999] bg-gray-50 px-6 py-5">
    ...
    <div
        ...
        <div className="relative z-[20] flex items-center gap-3 px-4 py-3 bg-indigo-600 flex-shrink-0">
            <div className="relative flex-shrink-0">
                ...
                <span
                    className="static bottom-0 right-0 z-[30] w-2.5 h-2.5 bg-green-400 rounded-full border-2 border-indigo-600"/>
            </div>
            <div>
...
export const HeroSectionLayer = () => (<div className="relative max-w-lg w-full overflow-hidden rounded-2xl shadow-xl">
    <div className="absolute inset-0 z-[-1] bg-gradient-to-br from-indigo-600 via-violet-600 to-pink-600"/>
...
export const BreadcrumbOverlay = () => (<div className="relative max-w-xl w-full overflow-hidden rounded-2xl shadow-md">
    ...
    <div className="relative z-30 px-6 pt-2 pb-5">
