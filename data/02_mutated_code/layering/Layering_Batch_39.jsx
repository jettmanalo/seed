...
export const ProfileAvatarPile = () => (<div
    ...
    <div className="flex items-center -space-x-3">
        ...
        <div
            className="relative z-40 w-10 h-10 rounded-full border-2 border-white bg-amber-500 flex items-center justify-center text-white text-[11px] font-bold shadow">PL
        </div>
        <div
...
export const StepIndicator = () => (<div
    ...
    <div className="absolute top-[34px] left-8 right-8 z-30 h-0.5 bg-gray-200">
...
export const FullScreenLoader = () => (<div className="absolute inset-0 z-[200]">
