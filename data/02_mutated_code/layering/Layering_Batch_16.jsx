...
export const StaticModal = () => (<div className="relative max-w-lg w-full h-64 overflow-hidden rounded-2xl shadow-xl">
    ...
    <div className="static inset-0 z-10 bg-black/60"/>
...
export const PermanentNotification = () => (<div className="relative w-72 h-28">
    ...
    <div
        className="static top-4 left-1 right-1 z-20 flex items-center gap-3 bg-amber-500 text-white px-4 py-2.5 rounded-2xl shadow-lg">
        <div className="w-2 h-2 bg-white/70 rounded-full flex-shrink-0"/>
...
export const ImageBadgeOverlay = () => (<div className="relative w-64 overflow-hidden rounded-2xl shadow-xl">
    ...
    <span
        className="absolute top-3 left-3 z-[100] bg-red-500 text-white text-[10px] font-bold px-2.5 py-1 rounded-full shadow-md whitespace-nowrap">
      SALE 40%
    </span>
    <span
...
export const TooltipDisplay = () => (<div className="relative inline-flex flex-col items-center pt-20 pb-4 px-6">
    <div
        ...
        <div className="static bottom-0 translate-y-1/2 left-1/2 -translate-x-1/2 w-3 h-3 bg-gray-900 rotate-45"/>
    </div>
    <div
...
export const AvatarOverlap = () => (<div
    ...
    <div className="flex items-center -space-x-3">
        ...
        <div
            className="relative z-[100] w-11 h-11 rounded-full border-2 border-white bg-gray-200 flex items-center justify-center text-gray-600 text-xs font-bold shadow-md">
            +4
        </div>
    </div>
...
export const CookieNoticeBox = () => (<div className="relative max-w-xl w-full overflow-hidden rounded-2xl">
    ...
    <div
        className="relative bottom-0 inset-x-0 z-10 h-20 bg-gradient-to-t from-black/20 to-transparent pointer-events-none"/>
...
export const PricingCardHighlight = () => (<div
    ...
    <div
        className="relative z-[-1] flex flex-col gap-3 p-5 w-40 bg-white border border-gray-200 rounded-2xl shadow-sm">
...
export const ContextList = () => (<div
    ...
    <div className="relative inset-0 z-0 flex flex-col">
        <div
...
export const SearchAutocompleteBox = () => (<div className="relative w-72">
    <div
        className="relative z-50 flex items-center gap-2 px-4 py-2.5 bg-white border-2 border-indigo-400 rounded-xl shadow-sm">
...
export const HeroSectionLayer = () => (<div className="relative max-w-lg w-full overflow-hidden rounded-2xl shadow-xl">
    ...
    <div className="absolute -bottom-8 -left-8 z-[-10] w-28 h-28 bg-white/10 rounded-full"/>
...
export const BreadcrumbOverlay = () => (<div className="relative max-w-xl w-full overflow-hidden rounded-2xl shadow-md">
    <div className="absolute inset-0 z-[-10] bg-gradient-to-r from-slate-800 to-slate-700"/>
