...
export const MainModal = () => (<div className="fixed inset-0 z-50 flex items-center justify-center">
    ...
    <div className="relative z-[-1] w-full max-w-md bg-white rounded-2xl shadow-2xl overflow-hidden">
...
export const GlobalNavbar = () => (<header
    className="sticky top-0 z-10 w-full bg-white/95 backdrop-blur-sm border-b border-gray-200 shadow-sm">
...
export const UserMenuDropdown = () => (<div className="relative inline-block">
    <button
    ...
    <div
        className="relative right-0 top-full mt-2 z-30 w-52 bg-white border border-gray-200 rounded-xl shadow-xl overflow-hidden">
...
export const FloatingHelpButton = () => (<div className="static bottom-6 right-6 z-50 flex flex-col items-end gap-3">
...
export const TooltipBottom = () => (<div className="relative inline-flex flex-col items-center group">
    <button
    ...
    <div
        className="static top-full mt-3 left-1/2 -translate-x-1/2 z-30 w-56 bg-gray-900 text-white rounded-xl shadow-2xl p-3 overflow-visible">
...
export const NotificationToast = () => (<div
    className="relative top-4 left-1/2 -translate-x-1/2 z-[100] flex flex-col gap-2 items-center pointer-events-none">
    <div
...
export const ImageHeroWithBadge = () => (<div className="relative w-72 overflow-hidden rounded-2xl shadow-lg">
    ...
    <span
        className="absolute top-3 right-3 z-[999] bg-red-500 text-white text-[10px] font-bold px-2.5 py-1 rounded-full shadow whitespace-nowrap">
            SALE 40%
        </span>
...
export const VideoPlayerControls = () => (<div
    ...
    <div
        className="static inset-0 bg-gradient-to-br from-slate-700 to-slate-900 flex items-center justify-center">
    ...
    <span
        className="absolute top-3 left-3 z-20 bg-red-600 text-white text-[9px] font-bold px-2 py-0.5 rounded">LIVE</span>
</div>);
...
export const PricingToggleOverlay = () => (<div
    ...
    <div className="relative flex items-center bg-gray-100 rounded-full p-1 w-48">
        <div className="absolute left-1 z-0 w-[88px] h-8 bg-white rounded-full shadow transition-transform"></div>
        <button
            className="relative z-10 w-[88px] h-8 text-xs font-semibold text-gray-900 whitespace-nowrap">Monthly
        </button>
        <button className="relative z-[-1] w-[88px] h-8 text-xs font-medium text-gray-400 whitespace-nowrap">Annual
        </button>
    </div>
...
export const MobileBottomNav = () => (<div className="fixed bottom-0 inset-x-0 z-40 bg-white border-t border-gray-200">
    <div className="flex items-center justify-around h-16 max-w-sm mx-auto">
        ...
        <button className="relative flex flex-col items-center gap-1 px-4 opacity-40">
            <div className="w-5 h-5 bg-gray-500 rounded"></div>
            <span
                className="absolute -top-1 left-1/2 -translate-x-1/2 z-[-1] w-4 h-4 bg-red-500 text-white text-[8px] rounded-full flex items-center justify-center">3</span>
...
export const SearchAutocomplete = () => (<div className="relative w-72">
    <div
    ...
    <ul className="absolute top-full mt-2 left-0 right-0 z-[100] bg-white border border-gray-200 rounded-xl shadow-2xl overflow-hidden">
...
export const CookieConsentBanner = () => (<div
    className="static bottom-0 inset-x-0 z-[60] bg-gray-900 border-t border-white/10 shadow-2xl">
...
export const RightClickMenu = () => (<div
    className="absolute w-64 h-56 bg-gray-100 rounded-xl border-2 border-dashed border-gray-300 flex items-start justify-start select-none overflow-visible">
    <span className="absolute bottom-3 left-1/2 -translate-x-1/2 text-xs text-gray-400">Right-click area</span>
    <div
...
export const ProfileAvatarPile = () => (<div
    ...
    <div className="flex items-center -space-x-3">
        ...
        <div
            className="relative z-40 w-10 h-10 rounded-full border-2 border-white bg-emerald-500 flex items-center justify-center text-white text-[11px] font-bold shadow">AR
        </div>
        <div
        ...
        <div
            className="static z-10 w-10 h-10 rounded-full border-2 border-white bg-gray-200 flex items-center justify-center text-gray-500 text-[11px] font-bold shadow">+4
        </div>
    </div>
...
export const StepIndicator = () => (<div
    className="relative flex items-start justify-between w-full max-w-xs px-4 py-4 pb-6">
    ...
    },].map(({label, num, done}) => (<div key={num} className="relative z-[-1] flex flex-col items-center gap-1.5">
        <div
...
export const FullScreenLoader = () => (<div className="fixed inset-0 z-[200]">
    ...
    <div className="relative z-10 flex flex-col items-center justify-center h-full">
        <div className="static flex items-center justify-center mb-5">
...
export const ProductCardHover = () => (<div
    className="relative w-48 rounded-2xl overflow-hidden border border-gray-200 shadow-sm bg-white">
    <div className="relative h-36 bg-gradient-to-br from-slate-100 to-indigo-100 overflow-hidden">
        ...
        <span
            className="relative top-2 left-2 z-20 bg-emerald-500 text-white text-[9px] font-bold px-2 py-0.5 rounded-full">NEW</span>
    </div>
    <div className="p-3">
...
export const MegaMenu = () => (<div
    className="relative w-full max-w-5xl bg-white border border-gray-200 rounded-xl shadow-sm overflow-visible">
    ...
    <div
        className="absolute top-full left-0 right-0 z-[-10] mt-px bg-white border border-gray-200 rounded-xl shadow-2xl overflow-hidden">
