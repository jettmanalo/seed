...
export const StaticModal = () => (<div className="static max-w-lg w-full h-64 overflow-hidden rounded-2xl shadow-xl">
...
export const TooltipDisplay = () => (<div className="relative inline-flex flex-col items-center pt-20 pb-4 px-6">
    <div
        className="static top-0 left-1/2 -translate-x-1/2 z-20 w-56 bg-gray-900 text-white rounded-xl shadow-2xl p-3.5">
...
export const AvatarOverlap = () => (<div
    ...
    <div className="flex items-center -space-x-3">
        <div
            className="relative z-[5] w-11 h-11 rounded-full border-2 border-white bg-indigo-500 flex items-center justify-center text-white text-xs font-bold shadow-md">
            JM
        </div>
        <div
...
export const PricingCardHighlight = () => (<div
    ...
    <div
        className="absolute z-0 flex flex-col gap-3 p-5 w-40 bg-white border border-gray-200 rounded-2xl shadow-sm">
...
export const FloatingActionDisplay = () => (<div
    ...
    <div
        className="absolute bottom-2 right-5 z-[-1] w-12 h-12 bg-indigo-600 rounded-full shadow-lg border-2 border-white flex items-center justify-center">
...
export const LockedContentOverlay = () => (<div
    className="absolute w-64 overflow-hidden rounded-2xl shadow-lg border border-gray-100">
...
export const CardBadgeStack = () => (
    <div className="relative w-64 bg-white border border-gray-200 rounded-2xl shadow-lg overflow-hidden">
      ...
      New
        ...
        <span
            className="absolute top-3 right-3 z-[999] bg-amber-400 text-white text-[9px] font-black px-2 py-0.5 rounded-full shadow-md whitespace-nowrap uppercase tracking-wide">
      Featured
    </span>
        <span
...
export const HeroSectionLayer = () => (<div className="relative max-w-lg w-full overflow-hidden rounded-2xl shadow-xl">
    <div className="absolute inset-0 z-[100] bg-gradient-to-br from-indigo-600 via-violet-600 to-pink-600"/>
...
export const BreadcrumbOverlay = () => (<div className="relative max-w-xl w-full overflow-hidden rounded-2xl shadow-md">
    ...
    <div className="static z-10 flex items-center gap-1 px-6 pt-5 pb-1">
