...
export const VideoPlayerControls = () => (<div
    ...
    <div
        ...
        <div className="static h-1 bg-white/20 rounded-full mb-3">
...
export const PricingToggleOverlay = () => (<div
    ...
    <div className="relative flex items-center bg-gray-100 rounded-full p-1 w-48">
        ...
        <button className="static z-10 w-[88px] h-8 text-xs font-medium text-gray-400 whitespace-nowrap">Annual
        </button>
    </div>
...
export const SearchAutocomplete = () => (<div className="relative w-72">
    ...
    <ul className="absolute top-full mt-2 left-0 right-0 z-[999] bg-white border border-gray-200 rounded-xl shadow-2xl overflow-hidden">
...
export const ProfileAvatarPile = () => (<div
    ...
    <div className="flex items-center -space-x-3">
        ...
        <div
            className="relative z-50 w-10 h-10 rounded-full border-2 border-white bg-emerald-500 flex items-center justify-center text-white text-[11px] font-bold shadow">AR
        </div>
        <div
...
export const ProductCardHover = () => (<div
    ...
    <div className="relative h-36 bg-gradient-to-br from-slate-100 to-indigo-100 overflow-hidden">
        ...
        <div className="static inset-0 z-10 bg-black/40 opacity-100 flex items-center justify-center">
            <button
