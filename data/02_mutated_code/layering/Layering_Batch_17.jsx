...
export const ImageHeroWithBadge = () => (<div className="absolute w-72 overflow-hidden rounded-2xl shadow-lg">
...
export const PricingToggleOverlay = () => (<div
    ...
    <div className="relative flex items-center bg-gray-100 rounded-full p-1 w-48">
        <div className="absolute left-1 z-[-1] w-[88px] h-8 bg-white rounded-full shadow transition-transform"></div>
        <button
...
export const MobileBottomNav = () => (<div className="fixed bottom-0 inset-x-0 z-40 bg-white border-t border-gray-200">
    <div className="flex items-center justify-around h-16 max-w-sm mx-auto">
        ...
        <button className="relative flex flex-col items-center gap-1 px-4 opacity-40">
            <div className="w-5 h-5 bg-gray-500 rounded"></div>
            <span
                className="absolute -top-1 left-1/2 -translate-x-1/2 z-[100] w-4 h-4 bg-red-500 text-white text-[8px] rounded-full flex items-center justify-center">3</span>
...
export const SearchAutocomplete = () => (<div className="relative w-72">
    ...
    <ul className="absolute top-full mt-2 left-0 right-0 z-[-1] bg-white border border-gray-200 rounded-xl shadow-2xl overflow-hidden">
...
export const ProfileAvatarPile = () => (<div
    ...
    <div className="flex items-center -space-x-3">
        ...
        <div
            className="relative z-[999] w-10 h-10 rounded-full border-2 border-white bg-gray-200 flex items-center justify-center text-gray-500 text-[11px] font-bold shadow">+4
        </div>
    </div>
...
export const FullScreenLoader = () => (<div className="fixed inset-0 z-[200]">
    <div className="absolute inset-0 z-50 bg-white/80 backdrop-blur-md"/>
