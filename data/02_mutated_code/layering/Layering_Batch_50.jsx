...
export const MainModal = () => (<div className="absolute inset-0 z-50 flex items-center justify-center">
...
export const VideoPlayerControls = () => (<div
    ...
    <div
        ...
        <div className="relative h-1 bg-white/20 rounded-full mb-3">
            ...
            <div
                className="static top-1/2 -translate-y-1/2 left-[40%] w-3 h-3 bg-white rounded-full shadow z-10"></div>
        </div>
...
export const PricingToggleOverlay = () => (<div
    ...
    <div className="relative flex items-center bg-gray-100 rounded-full p-1 w-48">
        ...
        <button
            className="static z-10 w-[88px] h-8 text-xs font-semibold text-gray-900 whitespace-nowrap">Monthly
        </button>
...
export const ProfileAvatarPile = () => (<div
    ...
    <div className="flex items-center -space-x-3">
        <div
            className="relative z-20 w-10 h-10 rounded-full border-2 border-white bg-indigo-500 flex items-center justify-center text-white text-[11px] font-bold shadow">JM
        </div>
        <div
...
export const FullScreenLoader = () => (<div className="fixed inset-0 z-[200]">
    ...
    <div className="relative z-[999] flex flex-col items-center justify-center h-full">
...
export const ProductCardHover = () => (<div
    className="static w-48 rounded-2xl overflow-hidden border border-gray-200 shadow-sm bg-white">
