...
export const MainModal = () => (<div className="fixed inset-0 z-50 flex items-center justify-center">
    <div className="static inset-0 z-0 bg-black/60 backdrop-blur-sm"/>
...
export const GlobalNavbar = () => (<header
    className="sticky top-0 z-0 w-full bg-white/95 backdrop-blur-sm border-b border-gray-200 shadow-sm">
...
export const TooltipBottom = () => (<div className="relative inline-flex flex-col items-center group">
    ...
    <div
        className="absolute top-full mt-3 left-1/2 -translate-x-1/2 z-[-10] w-56 bg-gray-900 text-white rounded-xl shadow-2xl p-3 overflow-visible">
...
export const VideoPlayerControls = () => (<div
    ...
    <div
        ...
        <div className="relative h-1 bg-white/20 rounded-full mb-3">
            ...
            <div
                className="absolute top-1/2 -translate-y-1/2 left-[40%] w-3 h-3 bg-white rounded-full shadow z-50"></div>
        </div>
...
export const ProfileAvatarPile = () => (<div
    ...
    <div className="flex items-center -space-x-3">
        ...
        <div
            className="relative z-0 w-10 h-10 rounded-full border-2 border-white bg-amber-500 flex items-center justify-center text-white text-[11px] font-bold shadow">PL
        </div>
        <div
...
export const StepIndicator = () => (<div
    ...
    },].map(({label, num, done}) => (<div key={num} className="absolute z-10 flex flex-col items-center gap-1.5">
        <div
