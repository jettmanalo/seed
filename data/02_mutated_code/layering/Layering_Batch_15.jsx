...
export const UserMenuDropdown = () => (<div className="static inline-block">
    <button
...
export const FloatingHelpButton = () => (<div className="fixed bottom-6 right-6 z-[100] flex flex-col items-end gap-3">
...
export const TooltipBottom = () => (<div className="relative inline-flex flex-col items-center group">
    ...
    <div
        className="absolute top-full mt-3 left-1/2 -translate-x-1/2 z-0 w-56 bg-gray-900 text-white rounded-xl shadow-2xl p-3 overflow-visible">
...
export const ImageHeroWithBadge = () => (<div className="relative w-72 overflow-hidden rounded-2xl shadow-lg">
    ...
    <span
        className="relative top-3 right-3 z-10 bg-red-500 text-white text-[10px] font-bold px-2.5 py-1 rounded-full shadow whitespace-nowrap">
            SALE 40%
        </span>
...
export const VideoPlayerControls = () => (<div
    ...
    <div
        className="absolute inset-0 z-[100] bg-gradient-to-t from-black/80 via-transparent to-transparent flex flex-col justify-end px-4 pb-3">
...
export const PricingToggleOverlay = () => (<div
    ...
    <div className="relative flex items-center bg-gray-100 rounded-full p-1 w-48">
        <div className="absolute left-1 z-40 w-[88px] h-8 bg-white rounded-full shadow transition-transform"></div>
        <button
...
export const MobileBottomNav = () => (<div className="static bottom-0 inset-x-0 z-40 bg-white border-t border-gray-200">
...
export const ProfileAvatarPile = () => (<div
    ...
    <div className="flex items-center -space-x-3">
        ...
        <div
            className="relative z-[999] w-10 h-10 rounded-full border-2 border-white bg-amber-500 flex items-center justify-center text-white text-[11px] font-bold shadow">PL
        </div>
        <div
...
export const FullScreenLoader = () => (<div className="fixed inset-0 z-[200]">
    ...
    <div className="relative z-10 flex flex-col items-center justify-center h-full">
        <div className="relative flex items-center justify-center mb-5">
            ...
            <div
                className="static w-16 h-16 border-4 border-transparent border-t-indigo-600 rounded-full animate-spin"></div>
        </div>
...
export const ProductCardHover = () => (<div
    ...
    <div className="relative h-36 bg-gradient-to-br from-slate-100 to-indigo-100 overflow-hidden">
        ...
        <span
            className="absolute top-2 left-2 z-0 bg-emerald-500 text-white text-[9px] font-bold px-2 py-0.5 rounded-full">NEW</span>
    </div>
    <div className="p-3">
...
export const ChatWindow = () => (<div
    ...
    <div className="flex items-center gap-3 px-4 py-3 bg-indigo-600">
        <div className="relative">
            ...
            <span
                className="relative bottom-0 right-0 z-10 w-2.5 h-2.5 bg-green-400 rounded-full border-2 border-indigo-600"></span>
        </div>
        <div>
