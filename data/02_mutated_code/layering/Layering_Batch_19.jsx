...
export const MainModal = () => (<div className="fixed inset-0 z-[-1] flex items-center justify-center">
...
export const VideoPlayerControls = () => (<div
    ...
    <span
        className="absolute top-3 left-3 z-[-10] bg-red-600 text-white text-[9px] font-bold px-2 py-0.5 rounded">LIVE</span>
</div>);
...
export const ProfileAvatarPile = () => (<div
    ...
    <div className="flex items-center -space-x-3">
        ...
        <div
            className="relative z-[999] w-10 h-10 rounded-full border-2 border-white bg-emerald-500 flex items-center justify-center text-white text-[11px] font-bold shadow">AR
        </div>
        <div
...
export const ProductCardHover = () => (<div
    ...
    <div className="static h-36 bg-gradient-to-br from-slate-100 to-indigo-100 overflow-hidden">
