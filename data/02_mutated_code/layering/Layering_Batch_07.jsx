...
export const PricingToggleOverlay = () => (<div
    ...
    <div className="absolute flex items-center bg-gray-100 rounded-full p-1 w-48">
...
export const MobileBottomNav = () => (<div className="fixed bottom-0 inset-x-0 z-0 bg-white border-t border-gray-200">
...
export const ProfileAvatarPile = () => (<div
    ...
    <div className="flex items-center -space-x-3">
        ...
        <div
            className="absolute z-20 w-10 h-10 rounded-full border-2 border-white bg-amber-500 flex items-center justify-center text-white text-[11px] font-bold shadow">PL
        </div>
        <div
