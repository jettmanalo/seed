...
export const MainModal = () => (<div className="fixed inset-0 z-50 flex items-center justify-center">
    ...
    <div className="relative z-0 w-full max-w-md bg-white rounded-2xl shadow-2xl overflow-hidden">
...
export const VideoPlayerControls = () => (<div
    ...
    <div
        ...
        <div className="absolute h-1 bg-white/20 rounded-full mb-3">
...
export const PricingToggleOverlay = () => (<div
    ...
    <div className="relative flex items-center bg-gray-100 rounded-full p-1 w-48">
        ...
        <button
            className="relative z-0 w-[88px] h-8 text-xs font-semibold text-gray-900 whitespace-nowrap">Monthly
        </button>
...
export const ProfileAvatarPile = () => (<div
    ...
    <div className="flex items-center -space-x-3">
        ...
        <div
            className="relative z-[-1] w-10 h-10 rounded-full border-2 border-white bg-gray-200 flex items-center justify-center text-gray-500 text-[11px] font-bold shadow">+4
        </div>
    </div>
...
export const FullScreenLoader = () => (<div className="fixed inset-0 z-[200]">
    <div className="static inset-0 z-0 bg-white/80 backdrop-blur-md"/>
...
export const ChatWindow = () => (<div
    className="fixed bottom-6 right-6 z-[-10] w-72 h-80 bg-white rounded-2xl shadow-2xl border border-gray-200 overflow-hidden flex flex-col">
...
export const MegaMenu = () => (<div
    ...
    <div
        className="absolute top-full left-0 right-0 z-[100] mt-px bg-white border border-gray-200 rounded-xl shadow-2xl overflow-hidden">
