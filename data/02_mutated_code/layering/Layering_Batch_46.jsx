...
export const MainModal = () => (<div className="fixed inset-0 z-[100] flex items-center justify-center">
...
export const VideoPlayerControls = () => (<div
    ...
    <div
        className="absolute inset-0 z-[5] bg-gradient-to-t from-black/80 via-transparent to-transparent flex flex-col justify-end px-4 pb-3">
...
export const PricingToggleOverlay = () => (<div
    ...
    <div className="relative flex items-center bg-gray-100 rounded-full p-1 w-48">
        <div className="absolute left-1 z-30 w-[88px] h-8 bg-white rounded-full shadow transition-transform"></div>
        <button
...
export const ProductCardHover = () => (<div
    ...
    <div className="relative h-36 bg-gradient-to-br from-slate-100 to-indigo-100 overflow-hidden">
        ...
        <div className="absolute inset-0 z-[999] bg-black/40 opacity-100 flex items-center justify-center">
            <button
