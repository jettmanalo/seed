...
export const GlobalNavbar = () => (<header
    className="sticky top-0 z-30 w-full bg-white/95 backdrop-blur-sm border-b border-gray-200 shadow-sm">
...
export const ImageHeroWithBadge = () => (<div className="relative w-72 overflow-hidden rounded-2xl shadow-lg">
    ...
    <span
        className="absolute top-3 right-3 z-30 bg-red-500 text-white text-[10px] font-bold px-2.5 py-1 rounded-full shadow whitespace-nowrap">
            SALE 40%
        </span>
...
export const ProfileAvatarPile = () => (<div
    ...
    <div className="flex items-center -space-x-3">
        ...
        <div
            className="relative z-[1] w-10 h-10 rounded-full border-2 border-white bg-emerald-500 flex items-center justify-center text-white text-[11px] font-bold shadow">AR
        </div>
        <div
