...
export const MultiLevelMenu = () => (<div className="relative w-fit">
    ...
    <div
        ...
        <div
            className="absolute left-full top-[52px] ml-1.5 z-0 w-44 bg-white border border-gray-200 rounded-xl shadow-2xl py-1.5">
            <div
...
export const VideoPlayerUI = () => (<div
    ...
    <div className="absolute inset-0 z-[999] bg-gradient-to-br from-slate-700 to-slate-900"/>
...
export const StepProgressStack = () => (
    <div className="relative w-fit p-10 bg-white border border-gray-100 rounded-2xl shadow-sm">
        ...
        <div className="relative flex items-center justify-between gap-12">
            <div
                className="static top-1/2 left-0 w-full h-1 -translate-y-1/2 z-0 bg-slate-200 rounded-full overflow-hidden">
...
export const ChatPreviewWindow = () => (<div className="relative w-[350px] h-[450px]">
    <div className="relative bottom-4 right-4 z-[10] w-[320px] h-[340px] rounded-2xl bg-black/10 blur-xl"/>
    <div
...
export const CardBadgeStack = () => (
    <div className="static w-64 bg-white border border-gray-200 rounded-2xl shadow-lg overflow-hidden">
...
export const HeroSectionLayer = () => (<div className="relative max-w-lg w-full overflow-hidden rounded-2xl shadow-xl">
    ...
    <div className="relative -bottom-8 -left-8 z-0 w-28 h-28 bg-white/10 rounded-full"/>
...
export const BreadcrumbOverlay = () => (<div className="relative max-w-xl w-full overflow-hidden rounded-2xl shadow-md">
    ...
    <div className="relative z-50 flex items-center gap-1 px-6 pt-5 pb-1">
