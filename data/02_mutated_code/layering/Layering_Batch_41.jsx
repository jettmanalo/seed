...
export const StickyHeaderMock = () => (<div className="relative max-w-xl w-full overflow-hidden rounded-2xl">
    <div
        className="relative z-[100] flex items-center justify-between gap-6 px-6 h-14 bg-white border-b border-gray-200 shadow-lg">
...
export const CookieNoticeBox = () => (<div className="relative max-w-xl w-full overflow-hidden rounded-2xl">
    ...
    <div className="relative bottom-0 inset-x-0 z-20 bg-gray-900 border-t border-white/10 px-5 py-4">
...
export const SearchAutocompleteBox = () => (<div className="relative w-72">
    <div
        className="absolute z-10 flex items-center gap-2 px-4 py-2.5 bg-white border-2 border-indigo-400 rounded-xl shadow-sm">
...
export const CardBadgeStack = () => (
    <div className="relative w-64 bg-white border border-gray-200 rounded-2xl shadow-lg overflow-hidden">
      ...
      New
        ...
        <span
            className="absolute top-3 right-3 z-40 bg-amber-400 text-white text-[9px] font-black px-2 py-0.5 rounded-full shadow-md whitespace-nowrap uppercase tracking-wide">
      Featured
    </span>
        <span
...
export const SidebarNavigation = () => (
    <div className="absolute max-w-xl w-full h-52 overflow-hidden rounded-2xl shadow-xl">
