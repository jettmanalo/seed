...
export const MainModal = () => (<div className="relative inset-0 z-50 flex items-center justify-center">
...
export const RightClickMenu = () => (<div
    ...
    <div
        className="relative top-4 left-8 z-[70] w-44 bg-white border border-gray-200 rounded-xl shadow-2xl py-1.5 overflow-hidden">
...
export const ProfileAvatarPile = () => (<div
    ...
    <div className="flex items-center -space-x-3">
        <div
            className="relative z-[-10] w-10 h-10 rounded-full border-2 border-white bg-indigo-500 flex items-center justify-center text-white text-[11px] font-bold shadow">JM
        </div>
        <div
...
export const StepIndicator = () => (<div
    ...
    <div className="static top-[34px] left-8 right-8 z-0 h-0.5 bg-gray-200">
