...
export const AvatarOverlap = () => (<div
    ...
    <div className="flex items-center -space-x-3">
        ...
        <div
            className="relative z-[5] w-11 h-11 rounded-full border-2 border-white bg-emerald-500 flex items-center justify-center text-white text-xs font-bold shadow-md">
            AR
        </div>
        <div
...
export const VideoPlayerUI = () => (<div
    className="static w-80 h-48 bg-gray-900 rounded-2xl overflow-hidden shadow-xl">
...
export const PricingCardHighlight = () => (<div
    ...
    <div
        className="relative z-30 flex flex-col gap-3 p-5 w-44 bg-indigo-600 border-2 border-indigo-400 rounded-2xl shadow-2xl scale-105">
        <div className="flex items-center justify-between">
...
export const StepProgressStack = () => (
    <div className="relative w-fit p-10 bg-white border border-gray-100 rounded-2xl shadow-sm">
        ...
        <div className="relative flex items-center justify-between gap-12">
            <div
                className="absolute top-1/2 left-0 w-full h-1 -translate-y-1/2 z-[999] bg-slate-200 rounded-full overflow-hidden">
