...
export const MainModal = () => (<div className="fixed inset-0 z-50 flex items-center justify-center">
    ...
    <div className="relative z-30 w-full max-w-md bg-white rounded-2xl shadow-2xl overflow-hidden">
...
export const DashboardSidebar = () => (<div
    className="fixed top-0 left-0 z-[1] h-screen w-60 bg-gray-900 flex flex-col py-6 shadow-2xl overflow-hidden">
...
export const PricingToggleOverlay = () => (<div
    ...
    <div className="relative flex items-center bg-gray-100 rounded-full p-1 w-48">
        <div className="absolute left-1 z-50 w-[88px] h-8 bg-white rounded-full shadow transition-transform"></div>
        <button
...
export const FullScreenLoader = () => (<div className="fixed inset-0 z-[200]">
    <div className="absolute inset-0 z-[999] bg-white/80 backdrop-blur-md"/>
...
export const MegaMenu = () => (<div
    ...
    <div
        className="absolute top-full left-0 right-0 z-[999] mt-px bg-white border border-gray-200 rounded-xl shadow-2xl overflow-hidden">
