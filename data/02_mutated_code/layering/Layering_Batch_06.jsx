...
export const StaticModal = () => (<div className="relative max-w-lg w-full h-64 overflow-hidden rounded-2xl shadow-xl">
    <div className="absolute inset-0 z-[1] bg-gradient-to-br from-slate-100 to-slate-200 p-5">
...
export const ImageBadgeOverlay = () => (<div className="static w-64 overflow-hidden rounded-2xl shadow-xl">
    <div
...
export const VideoPlayerUI = () => (<div
    ...
    <div className="absolute inset-0 z-20 bg-gradient-to-br from-slate-700 to-slate-900"/>
...
export const CookieNoticeBox = () => (<div className="relative max-w-xl w-full overflow-hidden rounded-2xl">
    ...
    <div className="absolute bottom-0 inset-x-0 z-[100] bg-gray-900 border-t border-white/10 px-5 py-4">
...
export const CardBadgeStack = () => (
    <div className="relative w-64 bg-white border border-gray-200 rounded-2xl shadow-lg overflow-hidden">
      ...
      Featured
        ...
        <span
            className="relative top-[106px] right-3 z-20 bg-indigo-600 text-white text-[9px] font-black px-2 py-0.5 rounded-full shadow-md whitespace-nowrap uppercase tracking-wide">
      Top
    </span>
...
export const HeroSectionLayer = () => (<div className="relative max-w-lg w-full overflow-hidden rounded-2xl shadow-xl">
    ...
    <div className="relative z-0 p-10 flex flex-col items-center text-center gap-5">
