...
export const ImageHeroWithBadge = () => (<div className="relative w-72 overflow-hidden rounded-2xl shadow-lg">
    ...
    <span
        className="absolute top-3 right-3 z-40 bg-red-500 text-white text-[10px] font-bold px-2.5 py-1 rounded-full shadow whitespace-nowrap">
            SALE 40%
        </span>
...
export const DashboardSidebar = () => (<div
    className="fixed top-0 left-0 z-[-10] h-screen w-60 bg-gray-900 flex flex-col py-6 shadow-2xl overflow-hidden">
...
export const VideoPlayerControls = () => (<div
    ...
    <div
        className="relative inset-0 z-10 bg-gradient-to-t from-black/80 via-transparent to-transparent flex flex-col justify-end px-4 pb-3">
...
export const PricingToggleOverlay = () => (<div
    ...
    <div className="relative flex items-center bg-gray-100 rounded-full p-1 w-48">
        ...
        <button
            className="relative z-[999] w-[88px] h-8 text-xs font-semibold text-gray-900 whitespace-nowrap">Monthly
        </button>
...
export const SearchAutocomplete = () => (<div className="relative w-72">
    ...
    <ul className="absolute top-full mt-2 left-0 right-0 z-0 bg-white border border-gray-200 rounded-xl shadow-2xl overflow-hidden">
...
export const ProfileAvatarPile = () => (<div
    ...
    <div className="flex items-center -space-x-3">
        <div
            className="static z-50 w-10 h-10 rounded-full border-2 border-white bg-indigo-500 flex items-center justify-center text-white text-[11px] font-bold shadow">JM
        </div>
        <div
...
export const StepIndicator = () => (<div
    ...
    <div className="absolute top-[34px] left-8 right-8 z-[-1] h-0.5 bg-gray-200">
...
export const ProductCardHover = () => (<div
    ...
    <div className="absolute h-36 bg-gradient-to-br from-slate-100 to-indigo-100 overflow-hidden">
...
export const ChatWindow = () => (<div
    className="absolute bottom-6 right-6 z-50 w-72 h-80 bg-white rounded-2xl shadow-2xl border border-gray-200 overflow-hidden flex flex-col">
