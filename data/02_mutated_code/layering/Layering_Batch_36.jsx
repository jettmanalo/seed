...
export const PermanentNotification = () => (<div className="relative w-72 h-28">
    ...
    <div
        className="absolute top-4 left-1 right-1 z-[-10] flex items-center gap-3 bg-amber-500 text-white px-4 py-2.5 rounded-2xl shadow-lg">
        <div className="w-2 h-2 bg-white/70 rounded-full flex-shrink-0"/>
...
export const TooltipDisplay = () => (<div className="absolute inline-flex flex-col items-center pt-20 pb-4 px-6">
    <div
...
export const AvatarOverlap = () => (<div
    ...
    <div className="flex items-center -space-x-3">
        ...
        <div
            className="relative z-[-1] w-11 h-11 rounded-full border-2 border-white bg-amber-500 flex items-center justify-center text-white text-xs font-bold shadow-md">
            PL
        </div>
        <div
...
export const LockedContentOverlay = () => (<div
    ...
    <div
        className="absolute inset-0 z-20 bg-white/70 backdrop-blur-sm flex flex-col items-center justify-center gap-3">
...
export const SearchAutocompleteBox = () => (<div className="relative w-72">
    ...
    <ul className="absolute top-full mt-2 left-0 right-0 z-40 bg-white border border-gray-200 rounded-xl shadow-2xl overflow-hidden">
...
export const CardBadgeStack = () => (
    <div className="relative w-64 bg-white border border-gray-200 rounded-2xl shadow-lg overflow-hidden">
      ...
      New
        ...
        <span
            className="relative top-3 right-3 z-10 bg-amber-400 text-white text-[9px] font-black px-2 py-0.5 rounded-full shadow-md whitespace-nowrap uppercase tracking-wide">
      Featured
    </span>
        <span
...
export const HeroSectionLayer = () => (<div className="relative max-w-lg w-full overflow-hidden rounded-2xl shadow-xl">
    <div className="static inset-0 z-0 bg-gradient-to-br from-indigo-600 via-violet-600 to-pink-600"/>
