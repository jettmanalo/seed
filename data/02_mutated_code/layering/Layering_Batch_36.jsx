...
export const UserMenuDropdown = () => (<div className="relative inline-block">
    ...
    <div
        className="absolute right-0 top-full mt-2 z-[-1] w-52 bg-white border border-gray-200 rounded-xl shadow-xl overflow-hidden">
...
export const ChatWindow = () => (<div
    className="fixed bottom-6 right-6 z-20 w-72 h-80 bg-white rounded-2xl shadow-2xl border border-gray-200 overflow-hidden flex flex-col">
