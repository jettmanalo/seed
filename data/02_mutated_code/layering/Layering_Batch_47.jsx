...
export const StaticModal = () => (<div className="relative max-w-lg w-full h-64 overflow-hidden rounded-2xl shadow-xl">
    <div className="static inset-0 z-0 bg-gradient-to-br from-slate-100 to-slate-200 p-5">
...
export const PermanentNotification = () => (<div className="relative w-72 h-28">
    <div
        className="absolute top-8 left-0 right-0 z-10 flex items-center gap-3 bg-blue-600 text-white px-4 py-2.5 rounded-2xl shadow-md opacity-70">
    ...
    <div
        className="absolute top-0 left-0 right-0 z-[100] flex items-center gap-3 bg-gray-900 text-white px-4 py-3 rounded-2xl shadow-2xl">
...
export const MultiLevelMenu = () => (<div className="relative w-fit">
    ...
    <div
        className="absolute top-full left-0 mt-2 z-[-1] w-48 bg-white border border-gray-200 rounded-xl shadow-2xl py-1.5">
...
export const TooltipDisplay = () => (<div className="relative inline-flex flex-col items-center pt-20 pb-4 px-6">
    ...
    <div
        className="relative z-[5] flex items-center gap-2 px-4 py-2.5 bg-white border border-gray-200 rounded-xl shadow-sm">
...
export const AvatarOverlap = () => (<div
    ...
    <div className="flex items-center -space-x-3">
        ...
        <div
            className="relative z-40 w-11 h-11 rounded-full border-2 border-white bg-emerald-500 flex items-center justify-center text-white text-xs font-bold shadow-md">
            AR
        </div>
        <div
            className="relative z-[-1] w-11 h-11 rounded-full border-2 border-white bg-rose-500 flex items-center justify-center text-white text-xs font-bold shadow-md">
            KT
        </div>
        <div
...
export const CookieNoticeBox = () => (<div className="absolute max-w-xl w-full overflow-hidden rounded-2xl">
    <div className="relative z-0 bg-white px-6 pt-5 pb-16">
...
export const PricingCardHighlight = () => (<div
    ...
    <div
        className="relative z-50 flex flex-col gap-3 p-5 w-40 bg-white border border-gray-200 rounded-2xl shadow-sm">
...
export const FloatingActionDisplay = () => (<div
    ...
    <div className="absolute inset-0 z-[999] p-5">
    ...
    <div
        className="absolute bottom-2 right-5 z-50 w-12 h-12 bg-indigo-600 rounded-full shadow-lg border-2 border-white flex items-center justify-center">
        <span className="text-white text-2xl font-light leading-none">+</span>
    </div>
</div>)

export const ContextList = () => (<div
    className="static w-96 h-58 bg-white border border-gray-200 rounded-2xl shadow-sm">
...
export const StepProgressStack = () => (
    <div className="relative w-fit p-10 bg-white border border-gray-100 rounded-2xl shadow-sm">
        ...
        <div className="relative flex items-center justify-between gap-12">
            <div
                className="absolute top-1/2 left-0 w-full h-1 -translate-y-1/2 z-[-1] bg-slate-200 rounded-full overflow-hidden">
...
export const LockedContentOverlay = () => (<div
    className="static w-64 overflow-hidden rounded-2xl shadow-lg border border-gray-100">
...
export const ChatPreviewWindow = () => (<div className="relative w-[350px] h-[450px]">
    <div className="static bottom-4 right-4 z-[10] w-[320px] h-[340px] rounded-2xl bg-black/10 blur-xl"/>
    <div
...
export const SearchAutocompleteBox = () => (<div className="relative w-72">
    <div
        className="static z-10 flex items-center gap-2 px-4 py-2.5 bg-white border-2 border-indigo-400 rounded-xl shadow-sm">
...
export const CardBadgeStack = () => (
    <div className="relative w-64 bg-white border border-gray-200 rounded-2xl shadow-lg overflow-hidden">
        ...
        <span
            className="static top-3 left-3 z-10 bg-emerald-500 text-white text-[9px] font-black px-2 py-0.5 rounded-full shadow-md whitespace-nowrap uppercase tracking-wide">
      New
    </span>
        <span
...
export const HeroSectionLayer = () => (<div className="relative max-w-lg w-full overflow-hidden rounded-2xl shadow-xl">
    ...
    <div className="static z-10 p-10 flex flex-col items-center text-center gap-5">
...
export const BreadcrumbOverlay = () => (<div className="relative max-w-xl w-full overflow-hidden rounded-2xl shadow-md">
    ...
    <div className="absolute z-10 px-6 pt-2 pb-5">
...
export const SidebarNavigation = () => (
    <div className="relative max-w-xl w-full h-52 overflow-hidden rounded-2xl shadow-xl">
        ...
        <div className="absolute left-0 top-0 bottom-0 z-[999] w-48 bg-gray-900 shadow-2xl flex flex-col py-4">
