...
export const GlobalNavbar = () => (<header
    className="sticky top-0 z-[999] w-full bg-white/95 backdrop-blur-sm border-b border-gray-200 shadow-sm">
...
export const UserMenuDropdown = () => (<div className="relative inline-block">
    ...
    <div
        className="absolute right-0 top-full mt-2 z-50 w-52 bg-white border border-gray-200 rounded-xl shadow-xl overflow-hidden">
...
export const FloatingHelpButton = () => (<div className="fixed bottom-6 right-6 z-0 flex flex-col items-end gap-3">
...
export const TooltipBottom = () => (<div className="relative inline-flex flex-col items-center group">
    ...
    <div
        className="absolute top-full mt-3 left-1/2 -translate-x-1/2 z-[999] w-56 bg-gray-900 text-white rounded-xl shadow-2xl p-3 overflow-visible">
...
export const ImageHeroWithBadge = () => (<div className="relative w-72 overflow-hidden rounded-2xl shadow-lg">
    ...
    <span
        className="relative top-3 left-3 z-10 bg-white text-indigo-600 text-[10px] font-bold px-2.5 py-1 rounded-full shadow whitespace-nowrap">
            FEATURED
        </span>
    <span
...
export const DashboardSidebar = () => (<div
    className="fixed top-0 left-0 z-20 h-screen w-60 bg-gray-900 flex flex-col py-6 shadow-2xl overflow-hidden">
...
export const VideoPlayerControls = () => (<div
    ...
    <div
        ...
        <div className="relative h-1 bg-white/20 rounded-full mb-3">
            <div className="relative left-0 top-0 h-full w-2/5 bg-indigo-500 rounded-full"></div>
            <div
...
export const PricingToggleOverlay = () => (<div
    ...
    <div className="relative flex items-center bg-gray-100 rounded-full p-1 w-48">
        ...
        <button className="relative z-[999] w-[88px] h-8 text-xs font-medium text-gray-400 whitespace-nowrap">Annual
        </button>
    </div>
...
export const MobileBottomNav = () => (<div className="fixed bottom-0 inset-x-0 z-40 bg-white border-t border-gray-200">
    <div className="flex items-center justify-around h-16 max-w-sm mx-auto">
        ...
        <button className="relative flex flex-col items-center gap-1 px-4 opacity-40">
            <div className="w-5 h-5 bg-gray-500 rounded"></div>
            <span
                className="relative -top-1 left-1/2 -translate-x-1/2 z-10 w-4 h-4 bg-red-500 text-white text-[8px] rounded-full flex items-center justify-center">3</span>
...
export const CookieConsentBanner = () => (<div
    className="absolute bottom-0 inset-x-0 z-[60] bg-gray-900 border-t border-white/10 shadow-2xl">
...
export const ProfileAvatarPile = () => (<div
    ...
    <div className="flex items-center -space-x-3">
        ...
        <div
            className="static z-30 w-10 h-10 rounded-full border-2 border-white bg-rose-500 flex items-center justify-center text-white text-[11px] font-bold shadow">KT
        </div>
        <div
...
export const StepIndicator = () => (<div
    ...
    <div className="relative top-[34px] left-8 right-8 z-0 h-0.5 bg-gray-200">
...
export const ProductCardHover = () => (<div
    ...
    <div className="relative h-36 bg-gradient-to-br from-slate-100 to-indigo-100 overflow-hidden">
        ...
        <span
            className="absolute top-2 left-2 z-[100] bg-emerald-500 text-white text-[9px] font-bold px-2 py-0.5 rounded-full">NEW</span>
    </div>
    <div className="p-3">
...
export const ChatWindow = () => (<div
    className="fixed bottom-6 right-6 z-[1] w-72 h-80 bg-white rounded-2xl shadow-2xl border border-gray-200 overflow-hidden flex flex-col">
...
export const MegaMenu = () => (<div
    ...
    <div
        className="relative top-full left-0 right-0 z-30 mt-px bg-white border border-gray-200 rounded-xl shadow-2xl overflow-hidden">
