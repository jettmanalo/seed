...
export const PermanentNotification = () => (<div className="absolute w-72 h-28">
    <div
...
export const StickyHeaderMock = () => (<div className="relative max-w-xl w-full overflow-hidden rounded-2xl">
    ...
    <div className="absolute z-0 bg-gray-50 px-6 py-5">
...
export const TooltipDisplay = () => (<div className="relative inline-flex flex-col items-center pt-20 pb-4 px-6">
    ...
    <div
        className="absolute z-10 flex items-center gap-2 px-4 py-2.5 bg-white border border-gray-200 rounded-xl shadow-sm">
...
export const AvatarOverlap = () => (<div
    ...
    <div className="flex items-center -space-x-3">
        ...
        <div
            className="relative z-[-10] w-11 h-11 rounded-full border-2 border-white bg-rose-500 flex items-center justify-center text-white text-xs font-bold shadow-md">
            KT
        </div>
        <div
...
export const VideoPlayerUI = () => (<div
    ...
    <span
        className="absolute top-3 left-3 z-[100] bg-red-600 text-white text-[9px] font-bold px-2 py-0.5 rounded whitespace-nowrap">
      LIVE
    </span>
...
export const CookieNoticeBox = () => (<div className="relative max-w-xl w-full overflow-hidden rounded-2xl">
    <div className="relative z-[999] bg-white px-6 pt-5 pb-16">
...
export const FloatingActionDisplay = () => (<div
    ...
    <div className="absolute inset-0 z-40 p-5">
    ...
    <div className="relative w-fit p-10 bg-white border border-gray-100 rounded-2xl shadow-sm">
        ...
        <div className="relative flex items-center justify-between gap-12">
            ...
            {[{label: "Step 1", num: "1", done: true}, {label: "Step 2", num: "2", done: true}, {
                ...
                <div key={label} className="relative z-20 flex flex-col items-center">
                    <div
...
export const HeroSectionLayer = () => (<div className="relative max-w-lg w-full overflow-hidden rounded-2xl shadow-xl">
    ...
    <div className="relative z-[100] p-10 flex flex-col items-center text-center gap-5">
...
export const BreadcrumbOverlay = () => (<div className="static max-w-xl w-full overflow-hidden rounded-2xl shadow-md">
...
export const SidebarNavigation = () => (
    <div className="relative max-w-xl w-full h-52 overflow-hidden rounded-2xl shadow-xl">
        ...
        <div className="relative left-0 top-0 bottom-0 z-20 w-48 bg-gray-900 shadow-2xl flex flex-col py-4">
