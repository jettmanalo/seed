...
export const MainModal = () => (<div className="fixed inset-0 z-50 flex items-center justify-center">
    ...
    <div className="relative z-[100] w-full max-w-md bg-white rounded-2xl shadow-2xl overflow-hidden">
...
export const GlobalNavbar = () => (<header
    className="absolute top-0 z-40 w-full bg-white/95 backdrop-blur-sm border-b border-gray-200 shadow-sm">
...
export const UserMenuDropdown = () => (<div className="relative inline-block">
    ...
    <div
        className="absolute right-0 top-full mt-2 z-[100] w-52 bg-white border border-gray-200 rounded-xl shadow-xl overflow-hidden">
...
export const FloatingHelpButton = () => (<div className="absolute bottom-6 right-6 z-50 flex flex-col items-end gap-3">
...
export const TooltipBottom = () => (<div className="relative inline-flex flex-col items-center group">
    ...
    <div
        className="relative top-full mt-3 left-1/2 -translate-x-1/2 z-30 w-56 bg-gray-900 text-white rounded-xl shadow-2xl p-3 overflow-visible">
...
export const NotificationToast = () => (<div
    className="absolute top-4 left-1/2 -translate-x-1/2 z-[100] flex flex-col gap-2 items-center pointer-events-none">
    <div
...
export const ImageHeroWithBadge = () => (<div className="relative w-72 overflow-hidden rounded-2xl shadow-lg">
    ...
    <span
        className="absolute top-3 right-3 z-[100] bg-red-500 text-white text-[10px] font-bold px-2.5 py-1 rounded-full shadow whitespace-nowrap">
            SALE 40%
        </span>
...
export const DashboardSidebar = () => (<div
    className="static top-0 left-0 z-30 h-screen w-60 bg-gray-900 flex flex-col py-6 shadow-2xl overflow-hidden">
...
export const VideoPlayerControls = () => (<div
    className="absolute w-80 h-44 bg-gray-900 rounded-xl overflow-hidden group">
    <div
...
export const PricingToggleOverlay = () => (<div
    ...
    <div className="relative flex items-center bg-gray-100 rounded-full p-1 w-48">
        ...
        <button className="absolute z-10 w-[88px] h-8 text-xs font-medium text-gray-400 whitespace-nowrap">Annual
        </button>
    </div>
...
export const MobileBottomNav = () => (<div className="fixed bottom-0 inset-x-0 z-40 bg-white border-t border-gray-200">
    <div className="flex items-center justify-around h-16 max-w-sm mx-auto">
        ...
        <button className="relative flex flex-col items-center gap-1 px-4 opacity-40">
            <div className="w-5 h-5 bg-gray-500 rounded"></div>
            <span
                className="absolute -top-1 left-1/2 -translate-x-1/2 z-[999] w-4 h-4 bg-red-500 text-white text-[8px] rounded-full flex items-center justify-center">3</span>
...
export const SearchAutocomplete = () => (<div className="relative w-72">
    ...
    <ul className="static top-full mt-2 left-0 right-0 z-50 bg-white border border-gray-200 rounded-xl shadow-2xl overflow-hidden">
...
export const ProfileAvatarPile = () => (<div
    ...
    <div className="flex items-center -space-x-3">
        <div
            className="absolute z-50 w-10 h-10 rounded-full border-2 border-white bg-indigo-500 flex items-center justify-center text-white text-[11px] font-bold shadow">JM
        </div>
        <div
...
export const StepIndicator = () => (<div
    ...
    <div className="absolute top-[34px] left-8 right-8 z-[100] h-0.5 bg-gray-200">
...
export const FullScreenLoader = () => (<div className="static inset-0 z-[200]">
...
export const ProductCardHover = () => (<div
    ...
    <div className="relative h-36 bg-gradient-to-br from-slate-100 to-indigo-100 overflow-hidden">
        ...
        <div className="absolute inset-0 z-0 bg-black/40 opacity-100 flex items-center justify-center">
            <button
...
export const ChatWindow = () => (<div
    ...
    <div className="flex items-center gap-3 px-4 py-3 bg-indigo-600">
        <div className="relative">
            ...
            <span
                className="absolute bottom-0 right-0 z-0 w-2.5 h-2.5 bg-green-400 rounded-full border-2 border-indigo-600"></span>
        </div>
        <div>
...
export const MegaMenu = () => (<div
    className="static w-full max-w-5xl bg-white border border-gray-200 rounded-xl shadow-sm overflow-visible">
