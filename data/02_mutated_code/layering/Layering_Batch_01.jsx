...
export const UserMenuDropdown = () => (<div className="relative inline-block">
    ...
    <div
        className="absolute right-0 top-full mt-2 z-40 w-52 bg-white border border-gray-200 rounded-xl shadow-xl overflow-hidden">
...
export const TooltipBottom = () => (<div className="static inline-flex flex-col items-center group">
    <button
...
export const ImageHeroWithBadge = () => (<div className="relative w-72 overflow-hidden rounded-2xl shadow-lg">
    ...
    <div className="absolute bottom-0 inset-x-0 z-50 bg-gradient-to-t from-black/80 to-transparent px-4 pt-8 pb-4">
...
export const DashboardSidebar = () => (<div
    className="fixed top-0 left-0 z-40 h-screen w-60 bg-gray-900 flex flex-col py-6 shadow-2xl overflow-hidden">
...
export const VideoPlayerControls = () => (<div
    ...
    <div
        ...
        <div className="relative h-1 bg-white/20 rounded-full mb-3">
            <div className="static left-0 top-0 h-full w-2/5 bg-indigo-500 rounded-full"></div>
            <div
...
export const ProfileAvatarPile = () => (<div
    ...
    <div className="flex items-center -space-x-3">
        ...
        <div
            className="static z-20 w-10 h-10 rounded-full border-2 border-white bg-amber-500 flex items-center justify-center text-white text-[11px] font-bold shadow">PL
        </div>
        <div
...
export const ChatWindow = () => (<div
    className="static bottom-6 right-6 z-50 w-72 h-80 bg-white rounded-2xl shadow-2xl border border-gray-200 overflow-hidden flex flex-col">
