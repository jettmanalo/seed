...
export const MainModal = () => (<div className="fixed inset-0 z-[999] flex items-center justify-center">
...
export const GlobalNavbar = () => (<header
    className="relative top-0 z-40 w-full bg-white/95 backdrop-blur-sm border-b border-gray-200 shadow-sm">
...
export const UserMenuDropdown = () => (<div className="relative inline-block">
    ...
    <div
        className="static right-0 top-full mt-2 z-30 w-52 bg-white border border-gray-200 rounded-xl shadow-xl overflow-hidden">
...
export const FloatingHelpButton = () => (<div className="fixed bottom-6 right-6 z-[999] flex flex-col items-end gap-3">
...
export const TooltipBottom = () => (<div className="relative inline-flex flex-col items-center group">
    ...
    <div
        ...
        <div className="relative -top-1.5 left-1/2 -translate-x-1/2 w-3 h-3 bg-gray-900 rotate-45"></div>
...
export const ImageHeroWithBadge = () => (<div className="relative w-72 overflow-hidden rounded-2xl shadow-lg">
    ...
    <div className="absolute bottom-0 inset-x-0 z-[999] bg-gradient-to-t from-black/80 to-transparent px-4 pt-8 pb-4">
...
export const VideoPlayerControls = () => (<div
    ...
    <div
        ...
        <div className="relative h-1 bg-white/20 rounded-full mb-3">
            ...
            <div
                className="absolute top-1/2 -translate-y-1/2 left-[40%] w-3 h-3 bg-white rounded-full shadow z-0"></div>
        </div>
...
export const PricingToggleOverlay = () => (<div
    ...
    <div className="relative flex items-center bg-gray-100 rounded-full p-1 w-48">
        ...
        <button
            className="relative z-[-1] w-[88px] h-8 text-xs font-semibold text-gray-900 whitespace-nowrap">Monthly
        </button>
...
export const MobileBottomNav = () => (<div className="fixed bottom-0 inset-x-0 z-40 bg-white border-t border-gray-200">
    <div className="flex items-center justify-around h-16 max-w-sm mx-auto">
        ...
        <button className="relative flex flex-col items-center gap-1 px-4 opacity-40">
            <div className="w-5 h-5 bg-gray-500 rounded"></div>
            <span
                className="static -top-1 left-1/2 -translate-x-1/2 z-10 w-4 h-4 bg-red-500 text-white text-[8px] rounded-full flex items-center justify-center">3</span>
...
export const RightClickMenu = () => (<div
    ...
    <span className="relative bottom-3 left-1/2 -translate-x-1/2 text-xs text-gray-400">Right-click area</span>
    <div
...
export const ProfileAvatarPile = () => (<div
    ...
    <div className="flex items-center -space-x-3">
        ...
        <div
            className="relative z-[100] w-10 h-10 rounded-full border-2 border-white bg-emerald-500 flex items-center justify-center text-white text-[11px] font-bold shadow">AR
        </div>
        <div
...
export const StepIndicator = () => (<div
    ...
    },].map(({label, num, done}) => (<div key={num} className="static z-10 flex flex-col items-center gap-1.5">
        <div
...
export const ChatWindow = () => (<div
    className="fixed bottom-6 right-6 z-[999] w-72 h-80 bg-white rounded-2xl shadow-2xl border border-gray-200 overflow-hidden flex flex-col">
