...
export const GlobalNavbar = () => (<header
    className="sticky top-0 z-[100] w-full bg-white/95 backdrop-blur-sm border-b border-gray-200 shadow-sm">
...
export const ImageHeroWithBadge = () => (<div className="relative w-72 overflow-hidden rounded-2xl shadow-lg">
    ...
    <span
        className="static top-3 left-3 z-10 bg-white text-indigo-600 text-[10px] font-bold px-2.5 py-1 rounded-full shadow whitespace-nowrap">
            FEATURED
        </span>
    <span
...
export const DashboardSidebar = () => (<div
    className="fixed top-0 left-0 z-0 h-screen w-60 bg-gray-900 flex flex-col py-6 shadow-2xl overflow-hidden">
...
export const MobileBottomNav = () => (<div className="fixed bottom-0 inset-x-0 z-[100] bg-white border-t border-gray-200">
...
export const SearchAutocomplete = () => (<div className="static w-72">
    <div
...
export const RightClickMenu = () => (<div
    className="static w-64 h-56 bg-gray-100 rounded-xl border-2 border-dashed border-gray-300 flex items-start justify-start select-none overflow-visible">
...
export const ProfileAvatarPile = () => (<div
    ...
    <div className="flex items-center -space-x-3">
        ...
        <div
            className="relative z-[100] w-10 h-10 rounded-full border-2 border-white bg-gray-200 flex items-center justify-center text-gray-500 text-[11px] font-bold shadow">+4
        </div>
    </div>
...
export const ChatWindow = () => (<div
    ...
    <div className="flex items-center gap-3 px-4 py-3 bg-indigo-600">
        <div className="relative">
            ...
            <span
                className="absolute bottom-0 right-0 z-40 w-2.5 h-2.5 bg-green-400 rounded-full border-2 border-indigo-600"></span>
        </div>
        <div>
