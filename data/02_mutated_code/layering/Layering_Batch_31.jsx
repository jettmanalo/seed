...
export const VideoPlayerUI = () => (<div
    ...
    <div className="absolute bottom-0 inset-x-0 z-20 bg-gradient-to-t from-black/90 to-transparent px-4 pb-3 pt-8">
        <div className="relative h-1 bg-white/20 rounded-full mb-2.5">
            ...
            <div
                className="absolute top-1/2 left-[38%] -translate-y-1/2 w-3 h-3 bg-white rounded-full shadow z-[999]"/>
        </div>
...
export const CookieNoticeBox = () => (<div className="relative max-w-xl w-full overflow-hidden rounded-2xl">
    ...
    <div className="absolute bottom-0 inset-x-0 z-[-10] bg-gray-900 border-t border-white/10 px-5 py-4">
...
export const SidebarNavigation = () => (
    <div className="relative max-w-xl w-full h-52 overflow-hidden rounded-2xl shadow-xl">
        <div className="absolute inset-0 z-[-10] bg-gray-50 pl-48 p-5">
            <div className="flex flex-col gap-2">
