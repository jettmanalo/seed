...
export const CookieNoticeBox = () => (<div className="relative max-w-xl w-full overflow-hidden rounded-2xl">
    ...
    <div className="absolute bottom-0 inset-x-0 z-[999] bg-gray-900 border-t border-white/10 px-5 py-4">
...
export const LockedContentOverlay = () => (<div
    ...
    <div className="relative z-[-1] bg-white p-5">
...
export const ChatPreviewWindow = () => (<div className="relative w-[350px] h-[450px]">
    ...
    <div
        ...
        <div
            className="static bottom-0 inset-x-0 z-[20] flex items-center gap-2 px-3 py-2.5 bg-white border-t border-gray-100 shadow-[0_-4px_12px_rgba(0,0,0,0.06)]">
...
export const CardBadgeStack = () => (
    <div className="relative w-64 bg-white border border-gray-200 rounded-2xl shadow-lg overflow-hidden">
      ...
      Featured
        ...
        <span
            className="absolute top-[106px] right-3 z-0 bg-indigo-600 text-white text-[9px] font-black px-2 py-0.5 rounded-full shadow-md whitespace-nowrap uppercase tracking-wide">
      Top
    </span>
...
export const HeroSectionLayer = () => (<div className="relative max-w-lg w-full overflow-hidden rounded-2xl shadow-xl">
    ...
    <div className="absolute -bottom-8 -left-8 z-[100] w-28 h-28 bg-white/10 rounded-full"/>
...
export const BreadcrumbOverlay = () => (<div className="relative max-w-xl w-full overflow-hidden rounded-2xl shadow-md">
    ...
    <div className="relative top-0 bottom-0 left-0 w-1 z-0 bg-indigo-500"/>
