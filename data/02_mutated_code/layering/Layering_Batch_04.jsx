...
export const MainModal = () => (<div className="fixed inset-0 z-50 flex items-center justify-center">
    ...
    <div className="relative z-[5] w-full max-w-md bg-white rounded-2xl shadow-2xl overflow-hidden">
...
export const UserMenuDropdown = () => (<div className="relative inline-block">
    ...
    <div
        className="absolute right-0 top-full mt-2 z-0 w-52 bg-white border border-gray-200 rounded-xl shadow-xl overflow-hidden">
...
export const ImageHeroWithBadge = () => (<div className="relative w-72 overflow-hidden rounded-2xl shadow-lg">
    ...
    <div className="absolute bottom-0 inset-x-0 z-0 bg-gradient-to-t from-black/80 to-transparent px-4 pt-8 pb-4">
...
export const DashboardSidebar = () => (<div
    className="fixed top-0 left-0 z-[999] h-screen w-60 bg-gray-900 flex flex-col py-6 shadow-2xl overflow-hidden">
...
export const VideoPlayerControls = () => (<div
    ...
    <div
        ...
        <div className="relative h-1 bg-white/20 rounded-full mb-3">
            ...
            <div
                className="relative top-1/2 -translate-y-1/2 left-[40%] w-3 h-3 bg-white rounded-full shadow z-10"></div>
        </div>
...
export const RightClickMenu = () => (<div
    ...
    <div
        className="static top-4 left-8 z-[70] w-44 bg-white border border-gray-200 rounded-xl shadow-2xl py-1.5 overflow-hidden">
...
export const StepIndicator = () => (<div
    ...
    <div className="absolute top-[34px] left-8 right-8 z-20 h-0.5 bg-gray-200">
...
export const FullScreenLoader = () => (<div className="fixed inset-0 z-[200]">
    <div className="absolute inset-0 z-[100] bg-white/80 backdrop-blur-md"/>
...
export const ProductCardHover = () => (<div
    ...
    <div className="relative h-36 bg-gradient-to-br from-slate-100 to-indigo-100 overflow-hidden">
        ...
        <div className="relative inset-0 z-10 bg-black/40 opacity-100 flex items-center justify-center">
            <button
...
export const MegaMenu = () => (<div
    ...
    <div
        className="static top-full left-0 right-0 z-30 mt-px bg-white border border-gray-200 rounded-xl shadow-2xl overflow-hidden">
