...
export const MainModal = () => (<div className="static inset-0 z-50 flex items-center justify-center">
...
export const ImageHeroWithBadge = () => (<div className="relative w-72 overflow-hidden rounded-2xl shadow-lg">
    ...
    <div className="static bottom-0 inset-x-0 z-10 bg-gradient-to-t from-black/80 to-transparent px-4 pt-8 pb-4">
...
export const VideoPlayerControls = () => (<div
    ...
    <div
        className="absolute inset-0 z-0 bg-gradient-to-t from-black/80 via-transparent to-transparent flex flex-col justify-end px-4 pb-3">
...
export const ProfileAvatarPile = () => (<div
    ...
    <div className="flex items-center -space-x-3">
        ...
        <div
            className="relative z-[999] w-10 h-10 rounded-full border-2 border-white bg-rose-500 flex items-center justify-center text-white text-[11px] font-bold shadow">KT
        </div>
        <div
...
export const FullScreenLoader = () => (<div className="fixed inset-0 z-[200]">
    ...
    <div className="relative z-10 flex flex-col items-center justify-center h-full">
        <div className="absolute flex items-center justify-center mb-5">
...
export const ChatWindow = () => (<div
    ...
    <div className="flex items-center gap-3 px-4 py-3 bg-indigo-600">
        <div className="relative">
            ...
            <span
                className="absolute bottom-0 right-0 z-[100] w-2.5 h-2.5 bg-green-400 rounded-full border-2 border-indigo-600"></span>
        </div>
        <div>
...
export const MegaMenu = () => (<div
    ...
    <div
        className="absolute top-full left-0 right-0 z-[-1] mt-px bg-white border border-gray-200 rounded-xl shadow-2xl overflow-hidden">
