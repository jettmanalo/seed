...
export const StaticModal = () => (<div className="relative max-w-lg w-full h-64 overflow-hidden rounded-2xl shadow-xl">
    <div className="relative inset-0 z-0 bg-gradient-to-br from-slate-100 to-slate-200 p-5">
...
export const ImageBadgeOverlay = () => (<div className="relative w-64 overflow-hidden rounded-2xl shadow-xl">
    ...
    <span
        className="absolute top-3 right-3 z-[100] bg-white text-indigo-700 text-[10px] font-bold px-2.5 py-1 rounded-full shadow-md whitespace-nowrap">
      NEW
    </span>
...
export const MultiLevelMenu = () => (<div className="relative w-fit">
    ...
    <div
        className="absolute top-full left-0 mt-2 z-[-10] w-48 bg-white border border-gray-200 rounded-xl shadow-2xl py-1.5">
...
export const StickyHeaderMock = () => (<div className="static max-w-xl w-full overflow-hidden rounded-2xl">
    <div
...
export const TooltipDisplay = () => (<div className="relative inline-flex flex-col items-center pt-20 pb-4 px-6">
    <div
        ...
        <div className="relative bottom-0 translate-y-1/2 left-1/2 -translate-x-1/2 w-3 h-3 bg-gray-900 rotate-45"/>
    </div>
    <div
...
export const AvatarOverlap = () => (<div
    ...
    <div className="flex items-center -space-x-3">
        ...
        <div
            className="static z-40 w-11 h-11 rounded-full border-2 border-white bg-emerald-500 flex items-center justify-center text-white text-xs font-bold shadow-md">
            AR
        </div>
        <div
...
export const VideoPlayerUI = () => (<div
    ...
    <div className="absolute bottom-0 inset-x-0 z-20 bg-gradient-to-t from-black/90 to-transparent px-4 pb-3 pt-8">
        <div className="relative h-1 bg-white/20 rounded-full mb-2.5">
            ...
            <div
                className="static top-1/2 left-[38%] -translate-y-1/2 w-3 h-3 bg-white rounded-full shadow z-30"/>
        </div>
...
export const CookieNoticeBox = () => (<div className="relative max-w-xl w-full overflow-hidden rounded-2xl">
    ...
    <div className="absolute bottom-0 inset-x-0 z-0 bg-gray-900 border-t border-white/10 px-5 py-4">
...
export const FloatingActionDisplay = () => (<div
    ...
    <div
        className="static bottom-2 right-5 z-50 w-12 h-12 bg-indigo-600 rounded-full shadow-lg border-2 border-white flex items-center justify-center">
...
export const StepProgressStack = () => (
    <div className="relative w-fit p-10 bg-white border border-gray-100 rounded-2xl shadow-sm">
        ...
        <div className="absolute flex items-center justify-between gap-12">
            <div
...
export const LockedContentOverlay = () => (<div
    ...
    <div
        className="static inset-0 z-10 bg-white/70 backdrop-blur-sm flex flex-col items-center justify-center gap-3">
...
export const ChatPreviewWindow = () => (<div className="relative w-[350px] h-[450px]">
    ...
    <div
        ...
        <div className="absolute z-[10] flex-1 bg-gray-50 px-4 pt-3 pb-16 flex flex-col gap-3 overflow-hidden">
...
export const CardBadgeStack = () => (
    <div className="relative w-64 bg-white border border-gray-200 rounded-2xl shadow-lg overflow-hidden">
      ...
      New
        ...
        <span
            className="absolute top-3 right-3 z-[-1] bg-amber-400 text-white text-[9px] font-black px-2 py-0.5 rounded-full shadow-md whitespace-nowrap uppercase tracking-wide">
      Featured
    </span>
        <span
...
export const HeroSectionLayer = () => (<div className="static max-w-lg w-full overflow-hidden rounded-2xl shadow-xl">
...
export const BreadcrumbOverlay = () => (<div className="relative max-w-xl w-full overflow-hidden rounded-2xl shadow-md">
    ...
    <div className="absolute top-0 bottom-0 left-0 w-1 z-[100] bg-indigo-500"/>
...
export const SidebarNavigation = () => (
    <div className="relative max-w-xl w-full h-52 overflow-hidden rounded-2xl shadow-xl">
        ...
        <div className="absolute left-0 top-0 bottom-0 z-0 w-48 bg-gray-900 shadow-2xl flex flex-col py-4">
