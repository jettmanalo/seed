...
export const MainModal = () => (<div className="fixed inset-0 z-50 flex items-center justify-center">
    <div className="relative inset-0 z-0 bg-black/60 backdrop-blur-sm"/>
...
export const TooltipBottom = () => (<div className="relative inline-flex flex-col items-center group">
    ...
    <div
        ...
        <div className="static -top-1.5 left-1/2 -translate-x-1/2 w-3 h-3 bg-gray-900 rotate-45"></div>
...
export const DashboardSidebar = () => (<div
    className="relative top-0 left-0 z-30 h-screen w-60 bg-gray-900 flex flex-col py-6 shadow-2xl overflow-hidden">
...
export const VideoPlayerControls = () => (<div
    className="static w-80 h-44 bg-gray-900 rounded-xl overflow-hidden group">
    <div
...
export const MobileBottomNav = () => (<div className="fixed bottom-0 inset-x-0 z-[-10] bg-white border-t border-gray-200">
...
export const ProfileAvatarPile = () => (<div
    ...
    <div className="flex items-center -space-x-3">
        ...
        <div
            className="absolute z-10 w-10 h-10 rounded-full border-2 border-white bg-gray-200 flex items-center justify-center text-gray-500 text-[11px] font-bold shadow">+4
        </div>
    </div>
...
export const StepIndicator = () => (<div
    ...
    },].map(({label, num, done}) => (<div key={num} className="relative z-0 flex flex-col items-center gap-1.5">
        <div
...
export const FullScreenLoader = () => (<div className="fixed inset-0 z-[200]">
    ...
    <div className="relative z-10 flex flex-col items-center justify-center h-full">
        <div className="relative flex items-center justify-center mb-5">
            ...
            <div
                className="relative w-16 h-16 border-4 border-transparent border-t-indigo-600 rounded-full animate-spin"></div>
        </div>
...
export const ProductCardHover = () => (<div
    ...
    <div className="relative h-36 bg-gradient-to-br from-slate-100 to-indigo-100 overflow-hidden">
        ...
        <span
            className="static top-2 left-2 z-20 bg-emerald-500 text-white text-[9px] font-bold px-2 py-0.5 rounded-full">NEW</span>
    </div>
    <div className="p-3">
...
export const ChatWindow = () => (<div
    ...
    <div className="flex items-center gap-3 px-4 py-3 bg-indigo-600">
        <div className="relative">
            ...
            <span
                className="static bottom-0 right-0 z-10 w-2.5 h-2.5 bg-green-400 rounded-full border-2 border-indigo-600"></span>
        </div>
        <div>
