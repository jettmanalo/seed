...
export const StaticModal = () => (<div className="relative max-w-lg w-full h-64 overflow-hidden rounded-2xl shadow-xl">
    ...
    <div className="static inset-0 z-20 flex items-center justify-center px-6">
...
export const ImageBadgeOverlay = () => (<div className="relative w-64 overflow-hidden rounded-2xl shadow-xl">
    ...
    <span
        className="static top-3 left-3 z-10 bg-red-500 text-white text-[10px] font-bold px-2.5 py-1 rounded-full shadow-md whitespace-nowrap">
      SALE 40%
    </span>
    <span
...
export const MultiLevelMenu = () => (<div className="relative w-fit">
    ...
    <div
        ...
        <div
            className="absolute left-full top-[52px] ml-1.5 z-[999] w-44 bg-white border border-gray-200 rounded-xl shadow-2xl py-1.5">
            <div
...
export const StickyHeaderMock = () => (<div className="relative max-w-xl w-full overflow-hidden rounded-2xl">
    <div
        className="relative z-[-1] flex items-center justify-between gap-6 px-6 h-14 bg-white border-b border-gray-200 shadow-lg">
...
export const TooltipDisplay = () => (<div className="relative inline-flex flex-col items-center pt-20 pb-4 px-6">
    <div
        className="absolute top-0 left-1/2 -translate-x-1/2 z-[-1] w-56 bg-gray-900 text-white rounded-xl shadow-2xl p-3.5">
...
export const AvatarOverlap = () => (<div
    ...
    <div className="flex items-center -space-x-3">
        ...
        <div
            className="static z-30 w-11 h-11 rounded-full border-2 border-white bg-rose-500 flex items-center justify-center text-white text-xs font-bold shadow-md">
            KT
        </div>
        <div
...
export const VideoPlayerUI = () => (<div
    ...
    <span
        className="absolute top-3 left-3 z-[-1] bg-red-600 text-white text-[9px] font-bold px-2 py-0.5 rounded whitespace-nowrap">
      LIVE
    </span>
...
export const CookieNoticeBox = () => (<div className="relative max-w-xl w-full overflow-hidden rounded-2xl">
    ...
    <div className="absolute bottom-0 inset-x-0 z-40 bg-gray-900 border-t border-white/10 px-5 py-4">
...
export const PricingCardHighlight = () => (<div
    ...
    <div
        className="relative z-[-1] flex flex-col gap-3 p-5 w-44 bg-indigo-600 border-2 border-indigo-400 rounded-2xl shadow-2xl scale-105">
        <div className="flex items-center justify-between">
...
export const StepProgressStack = () => (
    <div className="relative w-fit p-10 bg-white border border-gray-100 rounded-2xl shadow-sm">
        ...
        <div className="relative flex items-center justify-between gap-12">
            <div
                className="absolute top-1/2 left-0 w-full h-1 -translate-y-1/2 z-[5] bg-slate-200 rounded-full overflow-hidden">
...
export const SearchAutocompleteBox = () => (<div className="static w-72">
    <div
...
export const CardBadgeStack = () => (
    <div className="relative w-64 bg-white border border-gray-200 rounded-2xl shadow-lg overflow-hidden">
      ...
      Featured
        ...
        <span
            className="static top-[106px] right-3 z-20 bg-indigo-600 text-white text-[9px] font-black px-2 py-0.5 rounded-full shadow-md whitespace-nowrap uppercase tracking-wide">
      Top
    </span>
...
export const BreadcrumbOverlay = () => (<div className="relative max-w-xl w-full overflow-hidden rounded-2xl shadow-md">
    ...
    <div className="relative z-[100] px-6 pt-2 pb-5">
...
export const SidebarNavigation = () => (
    <div className="relative max-w-xl w-full h-52 overflow-hidden rounded-2xl shadow-xl">
        ...
        <div className="static left-0 top-0 bottom-0 z-20 w-48 bg-gray-900 shadow-2xl flex flex-col py-4">
