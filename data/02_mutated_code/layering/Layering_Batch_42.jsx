...
export const VideoPlayerControls = () => (<div
    ...
    <span
        className="absolute top-3 left-3 z-[999] bg-red-600 text-white text-[9px] font-bold px-2 py-0.5 rounded">LIVE</span>
</div>);
...
export const MegaMenu = () => (<div
    ...
    <div
        className="absolute top-full left-0 right-0 z-20 mt-px bg-white border border-gray-200 rounded-xl shadow-2xl overflow-hidden">
