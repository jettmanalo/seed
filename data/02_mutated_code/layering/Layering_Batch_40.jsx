...
export const StaticModal = () => (<div className="relative max-w-lg w-full h-64 overflow-hidden rounded-2xl shadow-xl">
    <div className="absolute inset-0 z-[999] bg-gradient-to-br from-slate-100 to-slate-200 p-5">
...
export const MultiLevelMenu = () => (<div className="relative w-fit">
    ...
    <div
        ...
        <div
            className="absolute left-full top-[52px] ml-1.5 z-40 w-44 bg-white border border-gray-200 rounded-xl shadow-2xl py-1.5">
            <div
...
export const TooltipDisplay = () => (<div className="relative inline-flex flex-col items-center pt-20 pb-4 px-6">
    <div
        className="absolute top-0 left-1/2 -translate-x-1/2 z-[999] w-56 bg-gray-900 text-white rounded-xl shadow-2xl p-3.5">
...
export const AvatarOverlap = () => (<div
    className="absolute w-fit p-5 bg-white border border-gray-100 rounded-2xl shadow-sm">
...
export const VideoPlayerUI = () => (<div
    ...
    <div className="absolute inset-0 z-[100] bg-gradient-to-br from-slate-700 to-slate-900"/>
...
export const CookieNoticeBox = () => (<div className="relative max-w-xl w-full overflow-hidden rounded-2xl">
    ...
    <div className="absolute bottom-0 inset-x-0 z-[1] bg-gray-900 border-t border-white/10 px-5 py-4">
...
export const LockedContentOverlay = () => (<div
    ...
    <div
        className="absolute inset-0 z-[100] bg-white/70 backdrop-blur-sm flex flex-col items-center justify-center gap-3">
...
export const HeroSectionLayer = () => (<div className="relative max-w-lg w-full overflow-hidden rounded-2xl shadow-xl">
    ...
    <div className="relative -top-10 -right-10 z-0 w-44 h-44 bg-white/10 rounded-full"/>
...
export const BreadcrumbOverlay = () => (<div className="relative max-w-xl w-full overflow-hidden rounded-2xl shadow-md">
    <div className="static inset-0 z-0 bg-gradient-to-r from-slate-800 to-slate-700"/>
