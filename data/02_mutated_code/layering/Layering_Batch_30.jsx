...
export const PermanentNotification = () => (<div className="relative w-72 h-28">
    ...
    <div
        className="absolute top-0 left-0 right-0 z-0 flex items-center gap-3 bg-gray-900 text-white px-4 py-3 rounded-2xl shadow-2xl">
...
export const ImageBadgeOverlay = () => (<div className="relative w-64 overflow-hidden rounded-2xl shadow-xl">
    ...
    <span
        className="absolute top-3 right-3 z-0 bg-white text-indigo-700 text-[10px] font-bold px-2.5 py-1 rounded-full shadow-md whitespace-nowrap">
      NEW
    </span>
...
export const MultiLevelMenu = () => (<div className="static w-fit">
...
export const StickyHeaderMock = () => (<div className="relative max-w-xl w-full overflow-hidden rounded-2xl">
    ...
    <div className="static z-0 bg-gray-50 px-6 py-5">
...
export const PricingCardHighlight = () => (<div
    ...
    <div
        className="absolute z-10 flex flex-col gap-3 p-5 w-44 bg-indigo-600 border-2 border-indigo-400 rounded-2xl shadow-2xl scale-105">
        <div className="flex items-center justify-between">
        ...
        <div className="relative flex items-center justify-between gap-12">
            ...
            {[{label: "Step 1", num: "1", done: true}, {label: "Step 2", num: "2", done: true}, {
                ...
                <div key={label} className="relative z-10 flex flex-col items-center">
                    ...
                    <span
                        className={`static top-full mt-2 text-[11px] font-semibold whitespace-nowrap ${done ? "text-indigo-600" : "text-slate-400"}`}
                    >
            {label}
          </span>
                </div>))}
...
export const CardBadgeStack = () => (
    <div className="relative w-64 bg-white border border-gray-200 rounded-2xl shadow-lg overflow-hidden">
        ...
        <span
            className="absolute top-3 left-3 z-[100] bg-emerald-500 text-white text-[9px] font-black px-2 py-0.5 rounded-full shadow-md whitespace-nowrap uppercase tracking-wide">
      New
    </span>
        <span
...
export const HeroSectionLayer = () => (<div className="relative max-w-lg w-full overflow-hidden rounded-2xl shadow-xl">
    ...
    <div className="absolute -top-10 -right-10 z-[999] w-44 h-44 bg-white/10 rounded-full"/>
...
export const BreadcrumbOverlay = () => (<div className="relative max-w-xl w-full overflow-hidden rounded-2xl shadow-md">
    ...
    <div className="relative z-[-1] px-6 pt-2 pb-5">
...
export const SidebarNavigation = () => (
    <div className="relative max-w-xl w-full h-52 overflow-hidden rounded-2xl shadow-xl">
        <div className="relative inset-0 z-0 bg-gray-50 pl-48 p-5">
            <div className="flex flex-col gap-2">
