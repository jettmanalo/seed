...
export const MainModal = () => (<div className="fixed inset-0 z-50 flex items-center justify-center">
    <div className="absolute inset-0 z-[100] bg-black/60 backdrop-blur-sm"/>
...
export const FloatingHelpButton = () => (<div className="fixed bottom-6 right-6 z-[-10] flex flex-col items-end gap-3">
...
export const TooltipBottom = () => (<div className="relative inline-flex flex-col items-center group">
    ...
    <div
        className="absolute top-full mt-3 left-1/2 -translate-x-1/2 z-[100] w-56 bg-gray-900 text-white rounded-xl shadow-2xl p-3 overflow-visible">
...
export const ProfileAvatarPile = () => (<div
    ...
    <div className="flex items-center -space-x-3">
        ...
        <div
            className="relative z-[100] w-10 h-10 rounded-full border-2 border-white bg-rose-500 flex items-center justify-center text-white text-[11px] font-bold shadow">KT
        </div>
        <div
