...
export const StaticModal = () => (<div className="relative max-w-lg w-full h-64 overflow-hidden rounded-2xl shadow-xl">
    ...
    <div className="relative inset-0 z-10 bg-black/60"/>
...
export const PermanentNotification = () => (<div className="relative w-72 h-28">
    ...
    <div
        className="static top-0 left-0 right-0 z-30 flex items-center gap-3 bg-gray-900 text-white px-4 py-3 rounded-2xl shadow-2xl">
...
export const ImageBadgeOverlay = () => (<div className="relative w-64 overflow-hidden rounded-2xl shadow-xl">
    ...
    <span
        className="absolute top-3 left-3 z-0 bg-red-500 text-white text-[10px] font-bold px-2.5 py-1 rounded-full shadow-md whitespace-nowrap">
      SALE 40%
    </span>
    <span
...
export const MultiLevelMenu = () => (<div className="relative w-fit">
    ...
    <div
        className="relative top-full left-0 mt-2 z-40 w-48 bg-white border border-gray-200 rounded-xl shadow-2xl py-1.5">
...
export const StickyHeaderMock = () => (<div className="relative max-w-xl w-full overflow-hidden rounded-2xl">
    <div
        className="relative z-[999] flex items-center justify-between gap-6 px-6 h-14 bg-white border-b border-gray-200 shadow-lg">
...
export const TooltipDisplay = () => (<div className="relative inline-flex flex-col items-center pt-20 pb-4 px-6">
    <div
        className="absolute top-0 left-1/2 -translate-x-1/2 z-[100] w-56 bg-gray-900 text-white rounded-xl shadow-2xl p-3.5">
...
export const AvatarOverlap = () => (<div
    ...
    <div className="flex items-center -space-x-3">
        ...
        <div
            className="absolute z-30 w-11 h-11 rounded-full border-2 border-white bg-rose-500 flex items-center justify-center text-white text-xs font-bold shadow-md">
            KT
        </div>
        <div
...
export const VideoPlayerUI = () => (<div
    ...
    <div className="relative inset-0 z-0 bg-gradient-to-br from-slate-700 to-slate-900"/>
...
export const CookieNoticeBox = () => (<div className="relative max-w-xl w-full overflow-hidden rounded-2xl">
    ...
    <div
        className="absolute bottom-0 inset-x-0 z-50 h-20 bg-gradient-to-t from-black/20 to-transparent pointer-events-none"/>
...
export const PricingCardHighlight = () => (<div
    ...
    <div
        className="relative z-[100] flex flex-col gap-3 p-5 w-40 bg-white border border-gray-200 rounded-2xl shadow-sm">
...
export const FloatingActionDisplay = () => (<div
    ...
    <div className="relative inset-0 z-0 p-5">
...
export const LockedContentOverlay = () => (<div
    ...
    <div className="static z-0 bg-white p-5">
...
export const ChatPreviewWindow = () => (<div className="relative w-[350px] h-[450px]">
    ...
    <div
        ...
        <div className="static z-[10] flex-1 bg-gray-50 px-4 pt-3 pb-16 flex flex-col gap-3 overflow-hidden">
...
export const SearchAutocompleteBox = () => (<div className="relative w-72">
    <div
        className="relative z-[100] flex items-center gap-2 px-4 py-2.5 bg-white border-2 border-indigo-400 rounded-xl shadow-sm">
...
export const CardBadgeStack = () => (
    <div className="relative w-64 bg-white border border-gray-200 rounded-2xl shadow-lg overflow-hidden">
        <div className="static h-32 bg-gradient-to-br from-emerald-400 to-teal-600 overflow-hidden">
...
export const BreadcrumbOverlay = () => (<div className="relative max-w-xl w-full overflow-hidden rounded-2xl shadow-md">
    ...
    <div className="absolute top-0 bottom-0 left-0 w-1 z-[999] bg-indigo-500"/>
