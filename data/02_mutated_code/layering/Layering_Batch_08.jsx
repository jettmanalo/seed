...
export const MainModal = () => (<div className="fixed inset-0 z-[-10] flex items-center justify-center">
...
export const MobileBottomNav = () => (<div className="fixed bottom-0 inset-x-0 z-[999] bg-white border-t border-gray-200">
...
export const ProfileAvatarPile = () => (<div
    ...
    <div className="flex items-center -space-x-3">
        <div
            className="relative z-30 w-10 h-10 rounded-full border-2 border-white bg-indigo-500 flex items-center justify-center text-white text-[11px] font-bold shadow">JM
        </div>
        <div
