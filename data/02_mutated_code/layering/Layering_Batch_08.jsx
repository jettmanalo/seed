...
export const VideoPlayerUI = () => (<div
    ...
    <div className="absolute bottom-0 inset-x-0 z-[100] bg-gradient-to-t from-black/90 to-transparent px-4 pb-3 pt-8">
...
export const HeroSectionLayer = () => (<div className="relative max-w-lg w-full overflow-hidden rounded-2xl shadow-xl">
    ...
    <div className="static -top-10 -right-10 z-0 w-44 h-44 bg-white/10 rounded-full"/>
...
export const BreadcrumbOverlay = () => (<div className="relative max-w-xl w-full overflow-hidden rounded-2xl shadow-md">
    ...
    <div className="relative z-[100] flex items-center gap-1 px-6 pt-5 pb-1">
