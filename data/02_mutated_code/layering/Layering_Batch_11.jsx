...
export const ImageHeroWithBadge = () => (<div className="relative w-72 overflow-hidden rounded-2xl shadow-lg">
    ...
    <div className="absolute bottom-0 inset-x-0 z-[-1] bg-gradient-to-t from-black/80 to-transparent px-4 pt-8 pb-4">
...
export const ProfileAvatarPile = () => (<div
    ...
    <div className="flex items-center -space-x-3">
        ...
        <div
            className="relative z-20 w-10 h-10 rounded-full border-2 border-white bg-gray-200 flex items-center justify-center text-gray-500 text-[11px] font-bold shadow">+4
        </div>
    </div>
...
export const FullScreenLoader = () => (<div className="relative inset-0 z-[200]">
...
export const ChatWindow = () => (<div
    className="relative bottom-6 right-6 z-50 w-72 h-80 bg-white rounded-2xl shadow-2xl border border-gray-200 overflow-hidden flex flex-col">
