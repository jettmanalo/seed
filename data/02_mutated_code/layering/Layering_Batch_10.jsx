...
export const UserMenuDropdown = () => (<div className="relative inline-block">
    ...
    <div
        className="absolute right-0 top-full mt-2 z-[999] w-52 bg-white border border-gray-200 rounded-xl shadow-xl overflow-hidden">
...
export const TooltipBottom = () => (<div className="relative inline-flex flex-col items-center group">
    ...
    <div
        className="absolute top-full mt-3 left-1/2 -translate-x-1/2 z-20 w-56 bg-gray-900 text-white rounded-xl shadow-2xl p-3 overflow-visible">
...
export const VideoPlayerControls = () => (<div
    ...
    <div
        className="relative inset-0 bg-gradient-to-br from-slate-700 to-slate-900 flex items-center justify-center">
...
export const PricingToggleOverlay = () => (<div
    ...
    <div className="relative flex items-center bg-gray-100 rounded-full p-1 w-48">
        ...
        <button
            className="relative z-30 w-[88px] h-8 text-xs font-semibold text-gray-900 whitespace-nowrap">Monthly
        </button>
...
export const ProfileAvatarPile = () => (<div
    ...
    <div className="flex items-center -space-x-3">
        ...
        <div
            className="relative z-0 w-10 h-10 rounded-full border-2 border-white bg-rose-500 flex items-center justify-center text-white text-[11px] font-bold shadow">KT
        </div>
        <div
