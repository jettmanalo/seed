...
export const PermanentNotification = () => (<div className="relative w-72 h-28">
    ...
    <div
        className="relative top-4 left-1 right-1 z-20 flex items-center gap-3 bg-amber-500 text-white px-4 py-2.5 rounded-2xl shadow-lg">
        <div className="w-2 h-2 bg-white/70 rounded-full flex-shrink-0"/>
...
export const ImageBadgeOverlay = () => (<div className="absolute w-64 overflow-hidden rounded-2xl shadow-xl">
    <div
...
export const MultiLevelMenu = () => (<div className="relative w-fit">
    ...
    <div
        className="absolute top-full left-0 mt-2 z-0 w-48 bg-white border border-gray-200 rounded-xl shadow-2xl py-1.5">
...
export const StickyHeaderMock = () => (<div className="relative max-w-xl w-full overflow-hidden rounded-2xl">
    <div
        className="relative z-0 flex items-center justify-between gap-6 px-6 h-14 bg-white border-b border-gray-200 shadow-lg">
...
export const AvatarOverlap = () => (<div
    ...
    <div className="flex items-center -space-x-3">
        <div
            className="relative z-[999] w-11 h-11 rounded-full border-2 border-white bg-indigo-500 flex items-center justify-center text-white text-xs font-bold shadow-md">
            JM
        </div>
        <div
...
export const VideoPlayerUI = () => (<div
    ...
    <div className="absolute inset-0 z-[-1] bg-gradient-to-br from-slate-700 to-slate-900"/>
...
export const CookieNoticeBox = () => (<div className="relative max-w-xl w-full overflow-hidden rounded-2xl">
    ...
    <div
        className="absolute bottom-0 inset-x-0 z-0 h-20 bg-gradient-to-t from-black/20 to-transparent pointer-events-none"/>
...
export const PricingCardHighlight = () => (<div
    className="absolute flex items-center justify-center gap-3 px-6 py-8 bg-gray-100 rounded-2xl">
    <div
...
export const FloatingActionDisplay = () => (<div
    ...
    <div className="static inset-0 z-0 p-5">
...
export const ContextList = () => (<div
    ...
    <div className="static inset-0 z-0 flex flex-col">
        <div
...
export const StepProgressStack = () => (
    <div className="absolute w-fit p-10 bg-white border border-gray-100 rounded-2xl shadow-sm">
...
export const ChatPreviewWindow = () => (<div className="relative w-[350px] h-[450px]">
    ...
    <div
        className="relative bottom-0 right-0 z-[20] w-[320px] h-[340px] flex flex-col rounded-2xl shadow-2xl ring-1 ring-black/10 overflow-hidden">
...
export const HeroSectionLayer = () => (<div className="absolute max-w-lg w-full overflow-hidden rounded-2xl shadow-xl">
...
export const BreadcrumbOverlay = () => (<div className="absolute max-w-xl w-full overflow-hidden rounded-2xl shadow-md">
