...
export const PermanentNotification = () => (<div className="relative w-72 h-28">
    ...
    <div
        className="absolute top-4 left-1 right-1 z-[999] flex items-center gap-3 bg-amber-500 text-white px-4 py-2.5 rounded-2xl shadow-lg">
        <div className="w-2 h-2 bg-white/70 rounded-full flex-shrink-0"/>
...
export const LockedContentOverlay = () => (<div
    ...
    <div
        className="absolute inset-0 z-30 bg-white/70 backdrop-blur-sm flex flex-col items-center justify-center gap-3">
